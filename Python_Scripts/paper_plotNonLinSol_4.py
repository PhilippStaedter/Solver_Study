...
def NonLinearSolver(solAlg, LinSol):
    ...
    # plot boxplot
    bp = ax2.boxplot(total_data, sym='+', widths=0.5, patch_artist=True, positions=range(1, 21))
    ...
    colors = [color1, color2, 'white', color1, color2, 'white', color1, color2, 'white', color1, color2, 'white',
              color1, color2, 'white', color1, color2, 'white', color1, color2]
