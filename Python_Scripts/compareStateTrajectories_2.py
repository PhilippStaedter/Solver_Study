...
for solAlg in [1, 2]:
    ...
    for iTolerance in Tolerance_combination:
        ...
        if not os.path.exists('../../Assessment_of_ODE_Solver_Performance_for_Biological_Processes/json_files/' + f'json_files_all_results_{MultistepMethod}_{atol_exp}_{rtol_exp}'):
            os.makedirs('../../Assessment_of_ODE_Solver_Performance_for_Biological_Processes/json_files/' + f'json_files_all_results_{MultistepMethod}_{atol_exp}_{rtol_exp}')
        ...
        for iAbsError in range(0, len(AbsError_1)):
            for iRelError in range(0, len(RelError_2)):
                ...
                if not os.path.exists('../../Assessment_of_ODE_Solver_Performance_for_Biological_Processes/json_files/' + f'json_files_all_results_{MultistepMethod}_{atol_exp}_{rtol_exp}' + '/json_files_' + abs_str + '_' + rel_str):
                    os.makedirs('../../Assessment_of_ODE_Solver_Performance_for_Biological_Processes/json_files/' + f'json_files_all_results_{MultistepMethod}_{atol_exp}_{rtol_exp}' + '/json_files_all_results_BDF/json_files_' + abs_str + '_' + rel_str)
                ...
                for iMod in range(0, len(list_directory_amici)):
                    ...
                    for iFile in list_files:
                        ...
                        # important paths
                        old_json_save_path = '../../Assessment_of_ODE_Solver_Performance_for_Biological_Processes/json_files/' + f'json_files_all_results_{MultistepMethod}_{atol_exp}_{rtol_exp}' + '/' + iModel + '/' + iFile
                        new_json_save_path = '../../Assessment_of_ODE_Solver_Performance_for_Biological_Processes/json_files/' + f'json_files_all_results_{MultistepMethod}_{atol_exp}_{rtol_exp}' + '/json_files_' + abs_str + '_' + rel_str + '/' + iModel + '/' + iFile                    # BDF
