...
ax1.text(0.5, 0.685, r'$10^{-3}$', fontsize=10)
ax1.text(0.5, 0.585, r'$10^{-6}$', fontsize=10)
ax1.text(0.5, 0.485, r'$10^{-6}$', fontsize=10)
ax1.text(0.5, 0.385, r'$10^{-16}$', fontsize=10)
ax1.text(0.5, 0.285, r'$10^{-12}$', fontsize=10)
# fourth column
ax1.text(0.79, 0.8, 'rel.tol.', fontsize=10)
ax1.text(0.8, 0.685, r'$10^{-3}$', fontsize=10)
ax1.text(0.8, 0.585, r'$10^{-3}$', fontsize=10)
ax1.text(0.8, 0.485, r'$10^{-6}$', fontsize=10)
ax1.text(0.8, 0.385, r'$10^{-8}$', fontsize=10)
ax1.text(0.8, 0.285, r'$10^{-12}$', fontsize=10)
