...
log_to_file(level=logging.WARN, filename="biomodels_import_warnings.log")
...
models = pd.DataFrame(columns=['model_id', 'model_name'], data=[model_id, model_name])

download_specific_sbml_biomodels_from_jws(model_id, model_name)
