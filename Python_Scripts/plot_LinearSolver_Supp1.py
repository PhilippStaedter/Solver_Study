...
# plot scatter plot of all data points for the accompynying linear solver +
#  linear regressions
fontsize = 12
labelsize = 8
alpha = 0.5
...
for iLinearSolverDataPoints in range(0, int(len(correct_files)/7)):
    ...
    data_regression = [l[0] for l in [
        10 ** k for k in [y_axis_interception + j
                          for j in [slope * i for i in num_x]]]]
...
colors = [color1, color2, color3, color4, color5, 'white',
          color1, color2, color3, color4, color5, 'white',
          color1, color2, color3, color4, color5, 'white',
          color1, color2, color3, color4, color5, 'white',
          color1, color2, color3, color4, color5, 'white',
          color1, color2, color3, color4, color5, 'white',
