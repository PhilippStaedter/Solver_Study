...
sources = ['swig/model1_piedrafita1.i', *getModelSources()]
...
# Build shared object
model_module = Extension('model1_piedrafita1._model1_piedrafita1',
                         sources=sources,
                         ...
                         swig_opts=['-c++', '-modern', '-outdir', 'model1_piedrafita1',
...
# Install
setup(
    name='model1_piedrafita1',
    version='0.1.0',
    description='AMICI-generated module for model model1_piedrafita1',
