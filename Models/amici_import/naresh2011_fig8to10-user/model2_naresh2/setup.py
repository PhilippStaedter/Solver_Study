...
sources = ['swig/model2_naresh2.i', *getModelSources()]
...
# Build shared object
model_module = Extension('model2_naresh2._model2_naresh2',
                         sources=sources,
                         ...
                         swig_opts=['-c++', '-modern', '-outdir', 'model2_naresh2',
...
setup(
    name='model2_naresh2',
    version='0.1.0',
    description='AMICI-generated module for model model2_naresh2',
