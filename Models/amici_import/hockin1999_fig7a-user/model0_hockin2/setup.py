...
sources = ['swig/model0_hockin2.i', *getModelSources()]
...
# Build shared object
model_module = Extension('model0_hockin2._model0_hockin2',
                         sources=sources,
                         ...
                         swig_opts=['-c++', '-modern', '-outdir', 'model0_hockin2',
...
setup(
    name='model0_hockin2',
    version='0.1.0',
    description='AMICI-generated module for model model0_hockin2',
