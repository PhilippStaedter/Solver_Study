...
sources = ['swig/model3_naresh2.i', *getModelSources()]
...
# Build shared object
model_module = Extension('model3_naresh2._model3_naresh2',
                         sources=sources,
                         ...
                         swig_opts=['-c++', '-modern', '-outdir', 'model3_naresh2',
...
setup(
    name='model3_naresh2',
    version='0.1.0',
    description='AMICI-generated module for model model3_naresh2',
