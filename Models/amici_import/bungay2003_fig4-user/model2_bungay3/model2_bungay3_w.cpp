...
void w_model2_bungay3(realtype *w, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *tcl){
    ...
    w[54] = 1.0*TF_VIIa_IX_l*k7;
    w[55] = -1.0*TF_VIIa_X_l*k9 + 1.0*TF_VIIa_l*X_l*k8;
    w[56] = 1.0*TF_VIIa_X_l*k10;
    w[57] = 1.0*TF_VIIa_Xa_l*k75;
    w[58] = -1.0*TF_VII_Xa_l*k12 + 1.0*TF_VII_l*Xa_l*k11;
    w[59] = 1.0*TF_VII_Xa_l*k13;
    w[60] = -1.0*IXa_VIIIa_l*k15 + 1.0*IXa_l*VIIIa_l*k14;
    w[61] = 1.0*Va_l*Xa_l*k16 - 1.0*Xa_Va_l*k17;
    w[62] = -1.0*IXa_VIIIa_X_l*k19 + 1.0*IXa_VIIIa_l*X_l*k18;
    w[63] = 1.0*IXa_VIIIa_X_l*k20;
    w[64] = -1.0*V_Xa_l*k22 + 1.0*V_l*Xa_l*k21;
    w[65] = 1.0*V_Xa_l*k23;
}