...
sources = ['swig/model3_mcauley1.i', *getModelSources()]
...
# Build shared object
model_module = Extension('model3_mcauley1._model3_mcauley1',
                         sources=sources,
                         ...
                         swig_opts=['-c++', '-modern', '-outdir', 'model3_mcauley1',
...
# Install
setup(
    name='model3_mcauley1',
    version='0.1.0',
    description='AMICI-generated module for model model3_mcauley1',
