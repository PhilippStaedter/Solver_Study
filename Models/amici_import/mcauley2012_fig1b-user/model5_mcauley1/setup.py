...
sources = ['swig/model5_mcauley1.i', *getModelSources()]
...
# Build shared object
model_module = Extension('model5_mcauley1._model5_mcauley1',
                         sources=sources,
                         ...
                         swig_opts=['-c++', '-modern', '-outdir', 'model5_mcauley1',
...
# Install
setup(
    name='model5_mcauley1',
    version='0.1.0',
    description='AMICI-generated module for model model5_mcauley1',
