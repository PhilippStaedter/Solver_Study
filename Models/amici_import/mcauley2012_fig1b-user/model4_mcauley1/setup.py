...
sources = ['swig/model4_mcauley1.i', *getModelSources()]
...
# Build shared object
model_module = Extension('model4_mcauley1._model4_mcauley1',
                         sources=sources,
                         ...
                         swig_opts=['-c++', '-modern', '-outdir', 'model4_mcauley1',
...
# Install
setup(
    name='model4_mcauley1',
    version='0.1.0',
    description='AMICI-generated module for model model4_mcauley1',
