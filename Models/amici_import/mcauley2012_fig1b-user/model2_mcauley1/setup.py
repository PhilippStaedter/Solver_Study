...
sources = ['swig/model2_mcauley1.i', *getModelSources()]
...
# Build shared object
model_module = Extension('model2_mcauley1._model2_mcauley1',
                         sources=sources,
                         ...
                         swig_opts=['-c++', '-modern', '-outdir', 'model2_mcauley1',
...
# Install
setup(
    name='model2_mcauley1',
    version='0.1.0',
    description='AMICI-generated module for model model2_mcauley1',
