...
void JSparse_bachmann(realtype *JSparse, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *dwdx){
    JSparse[0] = -2.5*dwdx1;
    JSparse[1] = -2.5*dwdx0;
    JSparse[2] = 2.5*dwdx0;
    JSparse[3] = 2.5*dwdx3;
