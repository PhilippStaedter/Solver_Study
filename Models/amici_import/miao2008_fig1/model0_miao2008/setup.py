...
sources = ['swig/model0_miao2008.i', *getModelSources()]
...
# Build shared object
model_module = Extension('model0_miao2008._model0_miao2008',
                         sources=sources,
                         ...
                         swig_opts=['-c++', '-modern', '-outdir', 'model0_miao2008',
...
# Install
setup(
    name='model0_miao2008',
    version='0.1.0',
    description='AMICI-generated module for model model0_miao2008',
