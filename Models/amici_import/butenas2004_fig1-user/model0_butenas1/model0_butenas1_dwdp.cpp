...
void dwdp_model0_butenas1(realtype *dwdp, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *tcl, const realtype *dtcldp, const int ip){
    switch(ip) {
        case 0:
            dwdp[0] = -1.0*TF_VII;
            break;
        case 1:
            dwdp[28] = 1.0*TF_VIIa_X;
            break;
        case 2:
            dwdp[29] = -1.0*TF_VIIa_Xa;
            break;
        case 3:
            dwdp[29] = 1.0*TF_VIIa*Xa;
            break;
        case 4:
            dwdp[30] = -1.0*TF_VIIa_IX;
            break;
        case 5:
            dwdp[30] = 1.0*IX*TF_VIIa;
            break;
        case 6:
            dwdp[31] = 1.0*TF_VIIa_IX;
            break;
        case 7:
            dwdp[32] = 1.0*II*Xa;
            break;
        ...
        case 41:
            ...
            break;
        case 42:
            dwdp[27] = -1.0*TF_VIIa_X;
            break;
        case 43:
            dwdp[27] = 1.0*TF_VIIa*X;
            break;
    }
}