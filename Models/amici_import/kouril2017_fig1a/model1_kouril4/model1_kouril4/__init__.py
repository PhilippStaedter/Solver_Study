"""AMICI-generated module for model model1_kouril4"""

import amici

# Ensure we are binary-compatible, see #556
if '0.10.7' != amici.__version__:
    raise RuntimeError('Cannot use model model1_kouril4, generated with AMICI '
...
from model1_kouril4.model1_kouril4 import *
