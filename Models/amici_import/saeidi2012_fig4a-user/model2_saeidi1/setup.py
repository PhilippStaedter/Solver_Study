...
sources = ['swig/model2_saeidi1.i', *getModelSources()]
...
# Build shared object
model_module = Extension('model2_saeidi1._model2_saeidi1',
                         sources=sources,
                         ...
                         swig_opts=['-c++', '-modern', '-outdir', 'model2_saeidi1',
...
setup(
    name='model2_saeidi1',
    version='0.1.0',
    description='AMICI-generated module for model model2_saeidi1',
