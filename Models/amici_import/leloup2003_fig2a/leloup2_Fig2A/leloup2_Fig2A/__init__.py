"""AMICI-generated module for model leloup2_Fig2A"""

import amici

# Ensure we are binary-compatible, see #556
if '0.10.7' != amici.__version__:
    raise RuntimeError('Cannot use model leloup2_Fig2A, generated with AMICI '
...
from leloup2_Fig2A.leloup2_Fig2A import *
