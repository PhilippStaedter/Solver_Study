...
sources = ['swig/model2_band2.i', *getModelSources()]
...
# Build shared object
model_module = Extension('model2_band2._model2_band2',
                         sources=sources,
                         ...
                         swig_opts=['-c++', '-modern', '-outdir', 'model2_band2',
...
setup(
    name='model2_band2',
    version='0.1.0',
    description='AMICI-generated module for model model2_band2',
