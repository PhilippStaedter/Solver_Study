"""AMICI-generated module for model model2_band2"""

import amici

# Ensure we are binary-compatible, see #556
if '0.10.7' != amici.__version__:
    raise RuntimeError('Cannot use model model2_band2, generated with AMICI '
...
from model2_band2.model2_band2 import *
