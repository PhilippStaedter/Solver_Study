...
/*-----------------------------------------------
              @(target):= _model0_Morris2002_CellCycle_CDK2Cyclin.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__model0_Morris2002_CellCycle_CDK2Cyclin

#else
#  define SWIG_init    init_model0_Morris2002_CellCycle_CDK2Cyclin

#endif
#define SWIG_name    "_model0_Morris2002_CellCycle_CDK2Cyclin"
