...
sources = ['swig/model1_mellor1.i', *getModelSources()]
...
# Build shared object
model_module = Extension('model1_mellor1._model1_mellor1',
                         sources=sources,
                         ...
                         swig_opts=['-c++', '-modern', '-outdir', 'model1_mellor1',
...
setup(
    name='model1_mellor1',
    version='0.1.0',
    description='AMICI-generated module for model model1_mellor1',
