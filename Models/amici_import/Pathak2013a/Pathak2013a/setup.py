...
sources = ['swig/Pathak2013a.i', *getModelSources()]
...
# Build shared object
model_module = Extension('Pathak2013a._Pathak2013a',
                         sources=sources,
                         ...
                         swig_opts=['-c++', '-modern', '-outdir', 'Pathak2013a',
...
setup(
    name='Pathak2013a',
    version='0.1.0',
    description='AMICI-generated module for model Pathak2013a',
