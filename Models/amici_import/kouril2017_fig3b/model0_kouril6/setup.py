...
sources = ['swig/model0_kouril6.i', *getModelSources()]
...
# Build shared object
model_module = Extension('model0_kouril6._model0_kouril6',
                         sources=sources,
                         ...
                         swig_opts=['-c++', '-modern', '-outdir', 'model0_kouril6',
...
setup(
    name='model0_kouril6',
    version='0.1.0',
    description='AMICI-generated module for model model0_kouril6',
