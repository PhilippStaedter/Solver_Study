...
void JSparse_model0_martins1(realtype *JSparse, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *dwdx){
    JSparse[0] = 1.0*dwdx1;
    ...
    JSparse[5] = 1.0*dwdx0;
    JSparse[6] = 1.0*dwdx4;
    JSparse[7] = -1.0*dwdx2 - 1.0*dwdx3 - 1.0*dwdx4;
    JSparse[8] = 1.0*dwdx2;
    JSparse[9] = 1.0*dwdx3;
    ...
    JSparse[18] = 1.0*dwdx8 + 1.0*dwdx9;
    ...
    JSparse[29] = -1.0*dwdx13 - 1.0*dwdx14;
    JSparse[30] = 1.0*dwdx15;
    JSparse[31] = 1.0*dwdx16;
    JSparse[32] = -1.0*dwdx15 - 1.0*dwdx16;
}