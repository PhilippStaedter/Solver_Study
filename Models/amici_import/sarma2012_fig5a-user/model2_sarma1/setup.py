...
sources = ['swig/model2_sarma1.i', *getModelSources()]
...
# Build shared object
model_module = Extension('model2_sarma1._model2_sarma1',
                         sources=sources,
                         ...
                         swig_opts=['-c++', '-modern', '-outdir', 'model2_sarma1',
...
setup(
    name='model2_sarma1',
    version='0.1.0',
    description='AMICI-generated module for model model2_sarma1',
