...
void x_solver_model3_levering2(realtype *x_solver, const realtype *x_rdata){
    ...
    x_solver[18] = species_3;
    x_solver[19] = species_4;
    x_solver[20] = species_5;
    x_solver[21] = species_6;
    x_solver[22] = species_7;
    x_solver[23] = species_8;
    x_solver[24] = species_9;
}