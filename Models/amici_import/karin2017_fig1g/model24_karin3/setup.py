...
sources = ['swig/model24_karin3.i', *getModelSources()]
...
# Build shared object
model_module = Extension('model24_karin3._model24_karin3',
                         sources=sources,
                         ...
                         swig_opts=['-c++', '-modern', '-outdir', 'model24_karin3',
...
setup(
    name='model24_karin3',
    version='0.1.0',
    description='AMICI-generated module for model model24_karin3',
