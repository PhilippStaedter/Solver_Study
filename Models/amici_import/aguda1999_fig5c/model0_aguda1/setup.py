...
sources = ['swig/model0_aguda1.i', *getModelSources()]
...
# Build shared object
model_module = Extension('model0_aguda1._model0_aguda1',
                         sources=sources,
                         ...
                         swig_opts=['-c++', '-modern', '-outdir', 'model0_aguda1',
...
setup(
    name='model0_aguda1',
    version='0.1.0',
    description='AMICI-generated module for model model0_aguda1',
