...
sources = ['swig/model0_kholodenko2.i', *getModelSources()]
...
# Build shared object
model_module = Extension('model0_kholodenko2._model0_kholodenko2',
                         sources=sources,
                         ...
                         swig_opts=['-c++', '-modern', '-outdir', 'model0_kholodenko2',
...
# Install
setup(
    name='model0_kholodenko2',
    version='0.1.0',
    description='AMICI-generated module for model model0_kholodenko2',
