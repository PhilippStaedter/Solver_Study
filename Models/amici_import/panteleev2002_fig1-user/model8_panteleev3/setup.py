...
sources = ['swig/model8_panteleev3.i', *getModelSources()]
...
# Build shared object
model_module = Extension('model8_panteleev3._model8_panteleev3',
                         sources=sources,
                         ...
                         swig_opts=['-c++', '-modern', '-outdir', 'model8_panteleev3',
...
# Install
setup(
    name='model8_panteleev3',
    version='0.1.0',
    description='AMICI-generated module for model model8_panteleev3',
