...
sources = ['swig/model7_panteleev3.i', *getModelSources()]
...
# Build shared object
model_module = Extension('model7_panteleev3._model7_panteleev3',
                         sources=sources,
                         ...
                         swig_opts=['-c++', '-modern', '-outdir', 'model7_panteleev3',
...
# Install
setup(
    name='model7_panteleev3',
    version='0.1.0',
    description='AMICI-generated module for model model7_panteleev3',
