...
sources = ['swig/model1_panteleev3.i', *getModelSources()]
...
# Build shared object
model_module = Extension('model1_panteleev3._model1_panteleev3',
                         sources=sources,
                         ...
                         swig_opts=['-c++', '-modern', '-outdir', 'model1_panteleev3',
...
# Install
setup(
    name='model1_panteleev3',
    version='0.1.0',
    description='AMICI-generated module for model model1_panteleev3',
