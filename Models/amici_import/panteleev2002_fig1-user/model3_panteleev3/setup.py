...
sources = ['swig/model3_panteleev3.i', *getModelSources()]
...
# Build shared object
model_module = Extension('model3_panteleev3._model3_panteleev3',
                         sources=sources,
                         ...
                         swig_opts=['-c++', '-modern', '-outdir', 'model3_panteleev3',
...
# Install
setup(
    name='model3_panteleev3',
    version='0.1.0',
    description='AMICI-generated module for model model3_panteleev3',
