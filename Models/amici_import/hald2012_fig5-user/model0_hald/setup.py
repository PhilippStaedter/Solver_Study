...
sources = ['swig/model0_hald.i', *getModelSources()]
...
# Build shared object
model_module = Extension('model0_hald._model0_hald',
                         sources=sources,
                         ...
                         swig_opts=['-c++', '-modern', '-outdir', 'model0_hald',
...
setup(
    name='model0_hald',
    version='0.1.0',
    description='AMICI-generated module for model model0_hald',
