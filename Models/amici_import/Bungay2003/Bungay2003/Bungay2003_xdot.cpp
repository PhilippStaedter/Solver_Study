...
void xdot_Bungay2003(realtype *xdot, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w){
    xdot[0] = -1.0*flux_r0;
    ...
    xdot[22] = -1.0*flux_r11 - 1.0*flux_r50 - 1.0*flux_r53;
    ...
    xdot[47] = -1.0*flux_r34 + 1.0*flux_r35 - 1.0*flux_r36 + 1.0*flux_r37 + 1.0*flux_r41 - 1.0*flux_r44 + 1.0*flux_r45 - 1.0*flux_r54 - 1.0*flux_r59;
    ...
    xdot[54] = 1.0*flux_r45 - 1.0*flux_r64 + 1.0*flux_r65;
    ...
    xdot[58] = -1.0*flux_r52 - 1.0*flux_r53 - 1.0*flux_r54 - 1.0*flux_r62;
    ...
    xdot[73] = -100.0*flux_r0 - 100.0*flux_r1 - 100.0*flux_r10 - 100.0*flux_r11 - 100.0*flux_r12 - 100.0*flux_r13 - 100.0*flux_r14 - 100.0*flux_r15 - 100.0*flux_r16 - 100.0*flux_r2 - 100.0*flux_r3 - 100.0*flux_r4 - 100.0*flux_r5 - 100.0*flux_r6 - 100.0*flux_r7 - 100.0*flux_r8 - 100.0*flux_r9;
}