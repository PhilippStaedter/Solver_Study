 ...
 * @return
 */
extern void J_model0_bachmann2(realtype *J, const realtype t, const realtype *x,
                            const realtype *p, const realtype *k,
                            const realtype *h, const realtype *w,
                            const realtype *dwdx);
extern void JB_model0_bachmann2(realtype *JB, const realtype t, const realtype *x,
                             const realtype *p, const realtype *k,
                             const realtype *h, const realtype *xB,
                             const realtype *w, const realtype *dwdx);
extern void JDiag_model0_bachmann2(realtype *JDiag, const realtype t,
                                const realtype *x, const realtype *p,
                                const realtype *k, const realtype *h,
                                const realtype *w, const realtype *dwdx);
extern void JSparse_model0_bachmann2(realtype *JSparse, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *dwdx);
extern void JSparse_colptrs_model0_bachmann2(sunindextype *colptrs);
extern void JSparse_rowvals_model0_bachmann2(sunindextype *rowvals);
extern void JSparseB_model0_bachmann2(realtype *JSparseB, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *xB, const realtype *w, const realtype *dwdx);
extern void JSparseB_colptrs_model0_bachmann2(sunindextype *colptrs);
extern void JSparseB_rowvals_model0_bachmann2(sunindextype *rowvals);
extern void Jy_model0_bachmann2(realtype *nllh, const int iy, const realtype *p,
                             const realtype *k, const realtype *y,
                             const realtype *sigmay, const realtype *my);
extern void dJydsigmay_model0_bachmann2(realtype *dJydsigmay, const int iy,
                                     const realtype *p, const realtype *k,
                                     const realtype *y, const realtype *sigmay,
                                     const realtype *my);
extern void dJydy_model0_bachmann2(realtype *dJydy, const int iy, const realtype *p, const realtype *k, const realtype *y, const realtype *sigmay, const realtype *my);
extern void dJydy_colptrs_model0_bachmann2(sunindextype *colptrs, int index);
extern void dJydy_rowvals_model0_bachmann2(sunindextype *rowvals, int index);
extern void dwdp_model0_bachmann2(realtype *dwdp, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *tcl, const realtype *dtcldp, const int ip);
extern void dwdx_model0_bachmann2(realtype *dwdx, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *tcl);
extern void dwdx_colptrs_model0_bachmann2(sunindextype *colptrs);
extern void dwdx_rowvals_model0_bachmann2(sunindextype *rowvals);
extern void dxdotdw_model0_bachmann2(realtype *dxdotdw, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w);
extern void dxdotdw_colptrs_model0_bachmann2(sunindextype *colptrs);
extern void dxdotdw_rowvals_model0_bachmann2(sunindextype *rowvals);
extern void dxdotdp_model0_bachmann2(realtype *dxdotdp, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const int ip, const realtype *w);
extern void dydx_model0_bachmann2(realtype *dydx, const realtype t,
                               const realtype *x, const realtype *p,
                               const realtype *k, const realtype *h,
                               const realtype *w, const realtype *dwdx);
extern void dydp_model0_bachmann2(realtype *dydp, const realtype t,
                               const realtype *x, const realtype *p,
                               const realtype *k, const realtype *h,
                               const int ip, const realtype *w,
                               const realtype *dwp);
extern void dsigmaydp_model0_bachmann2(realtype *dsigmaydp, const realtype t,
                                    const realtype *p, const realtype *k,
                                    const int ip);
extern void sigmay_model0_bachmann2(realtype *sigmay, const realtype t,
                                 const realtype *p, const realtype *k);
extern void w_model0_bachmann2(realtype *w, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *tcl);
extern void x0_model0_bachmann2(realtype *x0, const realtype t, const realtype *p,
                             const realtype *k);
extern void x0_fixedParameters_model0_bachmann2(realtype *x0, const realtype t,
                                             const realtype *p,
                                             const realtype *k);
extern void sx0_model0_bachmann2(realtype *sx0, const realtype t,
                              const realtype *x0, const realtype *p,
                              const realtype *k, const int ip);
extern void sx0_fixedParameters_model0_bachmann2(realtype *sx0, const realtype t,
                                              const realtype *x0,
                                              const realtype *p,
                                              const realtype *k, const int ip);
extern void xdot_model0_bachmann2(realtype *xdot, const realtype t,
                               const realtype *x, const realtype *p,
                               const realtype *k, const realtype *h,
                               const realtype *w);
extern void y_model0_bachmann2(realtype *y, const realtype t, const realtype *x,
                            const realtype *p, const realtype *k,
                            const realtype *h, const realtype *w);

extern void x_solver_model0_bachmann2(realtype *x_solver, const realtype *x_rdata);
extern void total_cl_model0_bachmann2(realtype *total_cl, const realtype *x_rdata);

/**
 * @brief AMICI-generated model subclass.
 */
class Model_model0_bachmann2 : public amici::Model_ODE {
  public:
    /**
     * @brief Default constructor.
     */
    Model_model0_bachmann2()
        : amici::Model_ODE(
              26,                                // nx_rdata
              26,                            // nxtrue_rdata
              26,                               // nx_solver
              ...
              std::vector<realtype>{0.0, 432.871, 0.530261, 784653000.0, 0.144775, 1.0, 1000.0, 0.00839842, 0.0, 0.267308, 1000000.0, 5.42932, 633253.0, 142.722, 0.001, 0.00816391, 173.653, 0.679157, 10.408, 1.06465, 1.0, 0.00830844, 10000.0, 0.0, 38.9757, 0.0780965, 0.0745155, 0.0268889, 1.24997e-07, 3.97622, 26.7251, 79.7535},       // dynamic parameters
    ...
    virtual amici::Model *clone() const override {
        return new Model_model0_bachmann2(*this);
    }
    ...
    virtual void fJ(realtype *J, const realtype t, const realtype *x,
        ...
        J_model0_bachmann2(J, t, x, p, k, h, w, dwdx);
    }
    ...
    virtual void fJB(realtype *JB, const realtype t, const realtype *x,
        ...
        JB_model0_bachmann2(JB, t, x, p, k, h, xB, w, dwdx);
    }
    ...
    virtual void fJDiag(realtype *JDiag, const realtype t, const realtype *x,
                        const realtype *p, const realtype *k, const realtype *h,
                        const realtype *w, const realtype *dwdx) override {
        JDiag_model0_bachmann2(JDiag, t, x, p, k, h, w, dwdx);
    }
    ...
    virtual void fJSparse(realtype *JSparse, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *dwdx) override {
        JSparse_model0_bachmann2( JSparse,  t,  x,  p,  k,  h,  w,  dwdx);
    }


    virtual void fJSparse_colptrs(sunindextype *colptrs) override {
        JSparse_colptrs_model0_bachmann2(colptrs);
    }


    virtual void fJSparse_rowvals(sunindextype *rowvals) override {
        JSparse_rowvals_model0_bachmann2(rowvals);
    }
    ...
    virtual void fJSparseB(realtype *JSparseB, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *xB, const realtype *w, const realtype *dwdx) override {
        JSparseB_model0_bachmann2( JSparseB,  t,  x,  p,  k,  h,  xB,  w,  dwdx);
    }


    virtual void fJSparseB_colptrs(sunindextype *colptrs) override {
        JSparseB_colptrs_model0_bachmann2(colptrs);
    }


    virtual void fJSparseB_rowvals(sunindextype *rowvals) override {
        JSparseB_rowvals_model0_bachmann2(rowvals);
    }
    ...
    virtual void fJy(realtype *nllh, const int iy, const realtype *p,
        ...
        Jy_model0_bachmann2(nllh, iy, p, k, y, sigmay, my);
    }
    ...
    virtual void fdJydsigma(realtype *dJydsigma, const int iy,
        ...
        dJydsigmay_model0_bachmann2(dJydsigma, iy, p, k, y, sigmay, my);
    }
    ...
    virtual void fdsigmaydp(realtype *dsigmaydp, const realtype t,
        ...
        dsigmaydp_model0_bachmann2(dsigmaydp, t, p, k, ip);
    }
    ...
    virtual void fdJydy(realtype *dJydy, const int iy, const realtype *p, const realtype *k, const realtype *y, const realtype *sigmay, const realtype *my) override {
        dJydy_model0_bachmann2( dJydy,  iy,  p,  k,  y,  sigmay,  my);
    }

    virtual void fdJydy_colptrs(sunindextype *colptrs, int index) override {
        dJydy_colptrs_model0_bachmann2(colptrs, index);
    }

    virtual void fdJydy_rowvals(sunindextype *rowvals, int index) override {
        dJydy_rowvals_model0_bachmann2(rowvals, index);
    }
    ...
    virtual void fdwdp(realtype *dwdp, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *tcl, const realtype *dtcldp, const int ip) override {
        dwdp_model0_bachmann2( dwdp,  t,  x,  p,  k,  h,  w,  tcl,  dtcldp,  ip);
    }
    ...
    virtual void fdwdx(realtype *dwdx, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *tcl) override {
        dwdx_model0_bachmann2( dwdx,  t,  x,  p,  k,  h,  w,  tcl);
    }
    ...
    virtual void fdxdotdw(realtype *dxdotdw, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w) override {
        dxdotdw_model0_bachmann2( dxdotdw,  t,  x,  p,  k,  h,  w);
    }


    virtual void fdxdotdw_colptrs(sunindextype *colptrs) override {
        dxdotdw_colptrs_model0_bachmann2(colptrs);
    }


    virtual void fdxdotdw_rowvals(sunindextype *rowvals) override {
        dxdotdw_rowvals_model0_bachmann2(rowvals);
    }
    ...
    virtual void fdxdotdp(realtype *dxdotdp, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const int ip, const realtype *w) override {
        dxdotdp_model0_bachmann2( dxdotdp,  t,  x,  p,  k,  h,  ip,  w);
    }
    ...
    virtual void fdydx(realtype *dydx, const realtype t, const realtype *x,
                       const realtype *p, const realtype *k, const realtype *h,
                       const realtype *w, const realtype *dwdx) override {
        dydx_model0_bachmann2(dydx, t, x, p, k, h, w, dwdx);
    }
    ...
    virtual void fdydp(realtype *dydp, const realtype t, const realtype *x,
        ...
        dydp_model0_bachmann2(dydp, t, x, p, k, h, ip, w, dwdp);
    }
    ...
    virtual void fsigmay(realtype *sigmay, const realtype t, const realtype *p,
        ...
        sigmay_model0_bachmann2(sigmay, t, p, k);
    }
    ...
    virtual void fsx0(realtype *sx0, const realtype t, const realtype *x0,
                      const realtype *p, const realtype *k,
                      const int ip) override {
        sx0_model0_bachmann2(sx0, t, x0, p, k, ip);
    }
    ...
    virtual void fsx0_fixedParameters(realtype *sx0, const realtype t,
                                      ...
                                      const realtype *k,
                                      const int ip) override {
        sx0_fixedParameters_model0_bachmann2(sx0, t, x0, p, k, ip);
    }
    ...
    virtual void fw(realtype *w, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *tcl) override {
        w_model0_bachmann2( w,  t,  x,  p,  k,  h,  tcl);
    }
    ...
    virtual void fx0_fixedParameters(realtype *x0, const realtype t,
                                     const realtype *p,
                                     const realtype *k) override {
        x0_fixedParameters_model0_bachmann2(x0, t, p, k);
    }
    ...
    virtual void fxdot(realtype *xdot, const realtype t, const realtype *x,
        ...
        xdot_model0_bachmann2(xdot, t, x, p, k, h, w);
    }
    ...
    virtual void fy(realtype *y, const realtype t, const realtype *x,
                    const realtype *p, const realtype *k, const realtype *h,
                    const realtype *w) override {
        y_model0_bachmann2(y, t, x, p, k, h, w);
    }
    ...
    virtual void fx_solver(realtype *x_solver, const realtype *x_rdata) override {
        x_solver_model0_bachmann2( x_solver,  x_rdata);
    }


    virtual void ftotal_cl(realtype *total_cl, const realtype *x_rdata) override {
        total_cl_model0_bachmann2( total_cl,  x_rdata);
    }
...
"",};
    ...
    virtual std::vector<std::string> getStateNames() const override {
        return std::vector<std::string>{"CIS",
"CISRNA",
"CISnRNA1",
"CISnRNA2",
"CISnRNA3",
...
"x25",};
    ...
    virtual std::vector<std::string> getParameterIds() const override {
        return std::vector<std::string>{"ActD",
"CISEqc",
"CISEqcOE",
"CISInh",
"CISRNADelay",
