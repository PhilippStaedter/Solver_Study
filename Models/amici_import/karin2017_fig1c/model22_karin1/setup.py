...
sources = ['swig/model22_karin1.i', *getModelSources()]
...
# Build shared object
model_module = Extension('model22_karin1._model22_karin1',
                         sources=sources,
                         ...
                         swig_opts=['-c++', '-modern', '-outdir', 'model22_karin1',
...
setup(
    name='model22_karin1',
    version='0.1.0',
    description='AMICI-generated module for model model22_karin1',
