...
sources = ['swig/ferreira1_Fig2F.i', *getModelSources()]
...
# Build shared object
model_module = Extension('ferreira1_Fig2F._ferreira1_Fig2F',
                         sources=sources,
                         ...
                         swig_opts=['-c++', '-modern', '-outdir', 'ferreira1_Fig2F',
...
# Install
setup(
    name='ferreira1_Fig2F',
    version='0.1.0',
    description='AMICI-generated module for model ferreira1_Fig2F',
