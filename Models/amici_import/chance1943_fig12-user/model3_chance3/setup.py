...
sources = ['swig/model3_chance3.i', *getModelSources()]
...
# Build shared object
model_module = Extension('model3_chance3._model3_chance3',
                         sources=sources,
                         ...
                         swig_opts=['-c++', '-modern', '-outdir', 'model3_chance3',
...
setup(
    name='model3_chance3',
    version='0.1.0',
    description='AMICI-generated module for model model3_chance3',
