...
sources = ['swig/model1_alexander2.i', *getModelSources()]
...
# Build shared object
model_module = Extension('model1_alexander2._model1_alexander2',
                         sources=sources,
                         ...
                         swig_opts=['-c++', '-modern', '-outdir', 'model1_alexander2',
...
# Install
setup(
    name='model1_alexander2',
    version='0.1.0',
    description='AMICI-generated module for model model1_alexander2',
