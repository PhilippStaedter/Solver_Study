...
sources = ['swig/model0_bucher1.i', *getModelSources()]
...
# Build shared object
model_module = Extension('model0_bucher1._model0_bucher1',
                         sources=sources,
                         ...
                         swig_opts=['-c++', '-modern', '-outdir', 'model0_bucher1',
...
setup(
    name='model0_bucher1',
    version='0.1.0',
    description='AMICI-generated module for model model0_bucher1',
