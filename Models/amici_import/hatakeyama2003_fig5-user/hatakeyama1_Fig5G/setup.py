...
sources = ['swig/hatakeyama1_Fig5G.i', *getModelSources()]
...
# Build shared object
model_module = Extension('hatakeyama1_Fig5G._hatakeyama1_Fig5G',
                         sources=sources,
                         ...
                         swig_opts=['-c++', '-modern', '-outdir', 'hatakeyama1_Fig5G',
...
# Install
setup(
    name='hatakeyama1_Fig5G',
    version='0.1.0',
    description='AMICI-generated module for model hatakeyama1_Fig5G',
