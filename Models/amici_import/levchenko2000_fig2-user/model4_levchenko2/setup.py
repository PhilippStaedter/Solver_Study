...
sources = ['swig/model4_levchenko2.i', *getModelSources()]
...
# Build shared object
model_module = Extension('model4_levchenko2._model4_levchenko2',
                         sources=sources,
                         ...
                         swig_opts=['-c++', '-modern', '-outdir', 'model4_levchenko2',
...
# Install
setup(
    name='model4_levchenko2',
    version='0.1.0',
    description='AMICI-generated module for model model4_levchenko2',
