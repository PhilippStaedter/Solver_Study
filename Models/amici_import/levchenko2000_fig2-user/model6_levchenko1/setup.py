...
sources = ['swig/model6_levchenko1.i', *getModelSources()]
...
# Build shared object
model_module = Extension('model6_levchenko1._model6_levchenko1',
                         sources=sources,
                         ...
                         swig_opts=['-c++', '-modern', '-outdir', 'model6_levchenko1',
...
# Install
setup(
    name='model6_levchenko1',
    version='0.1.0',
    description='AMICI-generated module for model model6_levchenko1',
