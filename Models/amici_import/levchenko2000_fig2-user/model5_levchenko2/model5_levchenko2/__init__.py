"""AMICI-generated module for model model5_levchenko2"""

import amici

# Ensure we are binary-compatible, see #556
if '0.10.7' != amici.__version__:
    raise RuntimeError('Cannot use model model5_levchenko2, generated with AMICI '
...
from model5_levchenko2.model5_levchenko2 import *
