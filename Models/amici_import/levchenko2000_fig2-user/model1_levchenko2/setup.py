...
sources = ['swig/model1_levchenko2.i', *getModelSources()]
...
# Build shared object
model_module = Extension('model1_levchenko2._model1_levchenko2',
                         sources=sources,
                         ...
                         swig_opts=['-c++', '-modern', '-outdir', 'model1_levchenko2',
...
# Install
setup(
    name='model1_levchenko2',
    version='0.1.0',
    description='AMICI-generated module for model model1_levchenko2',
