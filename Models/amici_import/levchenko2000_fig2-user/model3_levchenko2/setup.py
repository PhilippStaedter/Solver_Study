...
sources = ['swig/model3_levchenko2.i', *getModelSources()]
...
# Build shared object
model_module = Extension('model3_levchenko2._model3_levchenko2',
                         sources=sources,
                         ...
                         swig_opts=['-c++', '-modern', '-outdir', 'model3_levchenko2',
...
# Install
setup(
    name='model3_levchenko2',
    version='0.1.0',
    description='AMICI-generated module for model model3_levchenko2',
