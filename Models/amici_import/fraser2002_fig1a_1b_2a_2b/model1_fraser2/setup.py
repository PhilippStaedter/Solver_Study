...
sources = ['swig/model1_fraser2.i', *getModelSources()]
...
# Build shared object
model_module = Extension('model1_fraser2._model1_fraser2',
                         sources=sources,
                         ...
                         swig_opts=['-c++', '-modern', '-outdir', 'model1_fraser2',
...
setup(
    name='model1_fraser2',
    version='0.1.0',
    description='AMICI-generated module for model model1_fraser2',
