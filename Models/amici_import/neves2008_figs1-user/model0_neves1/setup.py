...
sources = ['swig/model0_neves1.i', *getModelSources()]
...
# Build shared object
model_module = Extension('model0_neves1._model0_neves1',
                         sources=sources,
                         ...
                         swig_opts=['-c++', '-modern', '-outdir', 'model0_neves1',
...
setup(
    name='model0_neves1',
    version='0.1.0',
    description='AMICI-generated module for model model0_neves1',
