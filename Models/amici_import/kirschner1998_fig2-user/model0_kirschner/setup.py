...
sources = ['swig/model0_kirschner.i', *getModelSources()]
...
# Build shared object
model_module = Extension('model0_kirschner._model0_kirschner',
                         sources=sources,
                         ...
                         swig_opts=['-c++', '-modern', '-outdir', 'model0_kirschner',
...
# Install
setup(
    name='model0_kirschner',
    version='0.1.0',
    description='AMICI-generated module for model model0_kirschner',
