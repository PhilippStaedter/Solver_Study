...
/*-----------------------------------------------
              @(target):= _model0_BIOMD0000000037.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__model0_BIOMD0000000037

#else
#  define SWIG_init    init_model0_BIOMD0000000037

#endif
#define SWIG_name    "_model0_BIOMD0000000037"
