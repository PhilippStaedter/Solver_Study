"""AMICI-generated module for model model0_kofahl"""

import amici

# Ensure we are binary-compatible, see #556
if '0.10.7' != amici.__version__:
    raise RuntimeError('Cannot use model model0_kofahl, generated with AMICI '
...
from model0_kofahl.model0_kofahl import *
