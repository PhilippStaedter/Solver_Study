...
sources = ['swig/model1_ribeiro1.i', *getModelSources()]
...
# Build shared object
model_module = Extension('model1_ribeiro1._model1_ribeiro1',
                         sources=sources,
                         ...
                         swig_opts=['-c++', '-modern', '-outdir', 'model1_ribeiro1',
...
# Install
setup(
    name='model1_ribeiro1',
    version='0.1.0',
    description='AMICI-generated module for model model1_ribeiro1',
