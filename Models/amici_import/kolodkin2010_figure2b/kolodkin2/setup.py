...
sources = ['swig/kolodkin2.i', *getModelSources()]
...
# Build shared object
model_module = Extension('kolodkin2._kolodkin2',
                         sources=sources,
                         ...
                         swig_opts=['-c++', '-modern', '-outdir', 'kolodkin2',
...
setup(
    name='kolodkin2',
    version='0.1.0',
    description='AMICI-generated module for model kolodkin2',
