...
void JSparseB_kolodkin2(realtype *JSparseB, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *xB, const realtype *w, const realtype *dwdx){
    JSparseB[0] = -1.0*dwdx0;
    JSparseB[1] = -1.0*dwdx1 + 1.0*dwdx2;
    JSparseB[2] = 1.0*dwdx4;
    JSparseB[3] = 1.0*dwdx5;
    JSparseB[4] = -1.0*dwdx2;
    JSparseB[5] = 1.0*dwdx3 - 1.0*dwdx4;
