...
sources = ['swig/kolodkin5.i', *getModelSources()]
...
# Build shared object
model_module = Extension('kolodkin5._kolodkin5',
                         sources=sources,
                         ...
                         swig_opts=['-c++', '-modern', '-outdir', 'kolodkin5',
...
setup(
    name='kolodkin5',
    version='0.1.0',
    description='AMICI-generated module for model kolodkin5',
