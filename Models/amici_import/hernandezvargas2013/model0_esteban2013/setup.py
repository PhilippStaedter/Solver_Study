...
sources = ['swig/model0_esteban2013.i', *getModelSources()]
...
# Build shared object
model_module = Extension('model0_esteban2013._model0_esteban2013',
                         sources=sources,
                         ...
                         swig_opts=['-c++', '-modern', '-outdir', 'model0_esteban2013',
...
# Install
setup(
    name='model0_esteban2013',
    version='0.1.0',
    description='AMICI-generated module for model model0_esteban2013',
