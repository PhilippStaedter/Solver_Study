...
sources = ['swig/model0_zi1.i', *getModelSources()]
...
# Build shared object
model_module = Extension('model0_zi1._model0_zi1',
                         sources=sources,
                         ...
                         swig_opts=['-c++', '-modern', '-outdir', 'model0_zi1',
...
setup(
    name='model0_zi1',
    version='0.1.0',
    description='AMICI-generated module for model model0_zi1',
