...
sources = ['swig/dupont2_Fig4B.i', *getModelSources()]
...
# Build shared object
model_module = Extension('dupont2_Fig4B._dupont2_Fig4B',
                         sources=sources,
                         ...
                         swig_opts=['-c++', '-modern', '-outdir', 'dupont2_Fig4B',
...
setup(
    name='dupont2_Fig4B',
    version='0.1.0',
    description='AMICI-generated module for model dupont2_Fig4B',
