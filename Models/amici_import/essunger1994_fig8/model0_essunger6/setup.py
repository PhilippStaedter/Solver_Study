...
sources = ['swig/model0_essunger6.i', *getModelSources()]
...
# Build shared object
model_module = Extension('model0_essunger6._model0_essunger6',
                         sources=sources,
                         ...
                         swig_opts=['-c++', '-modern', '-outdir', 'model0_essunger6',
...
# Install
setup(
    name='model0_essunger6',
    version='0.1.0',
    description='AMICI-generated module for model model0_essunger6',
