...
sources = ['swig/model0_schilling1.i', *getModelSources()]
...
# Build shared object
model_module = Extension('model0_schilling1._model0_schilling1',
                         sources=sources,
                         ...
                         swig_opts=['-c++', '-modern', '-outdir', 'model0_schilling1',
...
# Install
setup(
    name='model0_schilling1',
    version='0.1.0',
    description='AMICI-generated module for model model0_schilling1',
