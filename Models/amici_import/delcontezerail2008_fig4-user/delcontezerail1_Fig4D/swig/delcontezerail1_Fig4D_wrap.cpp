...
/*-----------------------------------------------
              @(target):= _delcontezerail1_Fig4D.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__delcontezerail1_Fig4D

#else
#  define SWIG_init    init_delcontezerail1_Fig4D

#endif
#define SWIG_name    "_delcontezerail1_Fig4D"
