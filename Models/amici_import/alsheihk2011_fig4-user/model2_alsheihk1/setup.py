...
sources = ['swig/model2_alsheihk1.i', *getModelSources()]
...
# Build shared object
model_module = Extension('model2_alsheihk1._model2_alsheihk1',
                         sources=sources,
                         ...
                         swig_opts=['-c++', '-modern', '-outdir', 'model2_alsheihk1',
...
# Install
setup(
    name='model2_alsheihk1',
    version='0.1.0',
    description='AMICI-generated module for model model2_alsheihk1',
