...
sources = ['swig/model4_hockin1.i', *getModelSources()]
...
# Build shared object
model_module = Extension('model4_hockin1._model4_hockin1',
                         sources=sources,
                         ...
                         swig_opts=['-c++', '-modern', '-outdir', 'model4_hockin1',
...
setup(
    name='model4_hockin1',
    version='0.1.0',
    description='AMICI-generated module for model model4_hockin1',
