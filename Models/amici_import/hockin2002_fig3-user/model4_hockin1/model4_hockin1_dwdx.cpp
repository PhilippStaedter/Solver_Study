...
void dwdx_model4_hockin1(realtype *dwdx, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *tcl){
    dwdx[0] = 1.0*Xa*k38;
    dwdx[1] = 1.0*k39*mIIa;
    dwdx[2] = 1.0*IXa*k40;
    dwdx[3] = 1.0*IIa*k41;
