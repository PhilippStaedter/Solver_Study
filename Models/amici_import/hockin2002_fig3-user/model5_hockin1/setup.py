...
sources = ['swig/model5_hockin1.i', *getModelSources()]
...
# Build shared object
model_module = Extension('model5_hockin1._model5_hockin1',
                         sources=sources,
                         ...
                         swig_opts=['-c++', '-modern', '-outdir', 'model5_hockin1',
...
setup(
    name='model5_hockin1',
    version='0.1.0',
    description='AMICI-generated module for model model5_hockin1',
