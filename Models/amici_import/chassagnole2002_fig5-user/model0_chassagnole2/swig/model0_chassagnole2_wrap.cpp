...
/*-----------------------------------------------
              @(target):= _model0_chassagnole2.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__model0_chassagnole2

#else
#  define SWIG_init    init_model0_chassagnole2

#endif
#define SWIG_name    "_model0_chassagnole2"
