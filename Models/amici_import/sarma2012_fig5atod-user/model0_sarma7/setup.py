...
sources = ['swig/model0_sarma7.i', *getModelSources()]
...
# Build shared object
model_module = Extension('model0_sarma7._model0_sarma7',
                         sources=sources,
                         ...
                         swig_opts=['-c++', '-modern', '-outdir', 'model0_sarma7',
...
setup(
    name='model0_sarma7',
    version='0.1.0',
    description='AMICI-generated module for model model0_sarma7',
