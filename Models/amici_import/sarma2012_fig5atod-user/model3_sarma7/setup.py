...
sources = ['swig/model3_sarma7.i', *getModelSources()]
...
# Build shared object
model_module = Extension('model3_sarma7._model3_sarma7',
                         sources=sources,
                         ...
                         swig_opts=['-c++', '-modern', '-outdir', 'model3_sarma7',
...
setup(
    name='model3_sarma7',
    version='0.1.0',
    description='AMICI-generated module for model model3_sarma7',
