...
sources = ['swig/model1_sarma7.i', *getModelSources()]
...
# Build shared object
model_module = Extension('model1_sarma7._model1_sarma7',
                         sources=sources,
                         ...
                         swig_opts=['-c++', '-modern', '-outdir', 'model1_sarma7',
...
setup(
    name='model1_sarma7',
    version='0.1.0',
    description='AMICI-generated module for model model1_sarma7',
