...
sources = ['swig/model0_kouril8.i', *getModelSources()]
...
# Build shared object
model_module = Extension('model0_kouril8._model0_kouril8',
                         sources=sources,
                         ...
                         swig_opts=['-c++', '-modern', '-outdir', 'model0_kouril8',
...
setup(
    name='model0_kouril8',
    version='0.1.0',
    description='AMICI-generated module for model model0_kouril8',
