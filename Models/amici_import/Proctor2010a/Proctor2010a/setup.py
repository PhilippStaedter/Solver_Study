...
sources = ['swig/Proctor2010a.i', *getModelSources()]
...
# Build shared object
model_module = Extension('Proctor2010a._Proctor2010a',
                         sources=sources,
                         ...
                         swig_opts=['-c++', '-modern', '-outdir', 'Proctor2010a',
...
setup(
    name='Proctor2010a',
    version='0.1.0',
    description='AMICI-generated module for model Proctor2010a',
