...
sources = ['swig/model1_tripathi1.i', *getModelSources()]
...
# Build shared object
model_module = Extension('model1_tripathi1._model1_tripathi1',
                         sources=sources,
                         ...
                         swig_opts=['-c++', '-modern', '-outdir', 'model1_tripathi1',
...
# Install
setup(
    name='model1_tripathi1',
    version='0.1.0',
    description='AMICI-generated module for model model1_tripathi1',
