...
/*-----------------------------------------------
              @(target):= _fung1_Fig3A_Vgly_0_5.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__fung1_Fig3A_Vgly_0_5

#else
#  define SWIG_init    init_fung1_Fig3A_Vgly_0_5

#endif
#define SWIG_name    "_fung1_Fig3A_Vgly_0_5"
