...
sources = ['swig/model0_kofahl.i', *getModelSources()]
...
# Build shared object
model_module = Extension('model0_kofahl._model0_kofahl',
                         sources=sources,
                         ...
                         swig_opts=['-c++', '-modern', '-outdir', 'model0_kofahl',
...
setup(
    name='model0_kofahl',
    version='0.1.0',
    description='AMICI-generated module for model model0_kofahl',
