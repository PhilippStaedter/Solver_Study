...
sources = ['swig/model29_beuke30.i', *getModelSources()]
...
# Build shared object
model_module = Extension('model29_beuke30._model29_beuke30',
                         sources=sources,
                         ...
                         swig_opts=['-c++', '-modern', '-outdir', 'model29_beuke30',
...
# Install
setup(
    name='model29_beuke30',
    version='0.1.0',
    description='AMICI-generated module for model model29_beuke30',
