...
sources = ['swig/kolodkin4.i', *getModelSources()]
...
# Build shared object
model_module = Extension('kolodkin4._kolodkin4',
                         sources=sources,
                         ...
                         swig_opts=['-c++', '-modern', '-outdir', 'kolodkin4',
...
setup(
    name='kolodkin4',
    version='0.1.0',
    description='AMICI-generated module for model kolodkin4',
