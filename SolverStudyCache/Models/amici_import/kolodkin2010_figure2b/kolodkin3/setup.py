...
sources = ['swig/kolodkin3.i', *getModelSources()]
...
# Build shared object
model_module = Extension('kolodkin3._kolodkin3',
                         sources=sources,
                         ...
                         swig_opts=['-c++', '-modern', '-outdir', 'kolodkin3',
...
setup(
    name='kolodkin3',
    version='0.1.0',
    description='AMICI-generated module for model kolodkin3',
