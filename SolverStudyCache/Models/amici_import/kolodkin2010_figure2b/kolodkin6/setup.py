...
sources = ['swig/kolodkin6.i', *getModelSources()]
...
# Build shared object
model_module = Extension('kolodkin6._kolodkin6',
                         sources=sources,
                         ...
                         swig_opts=['-c++', '-modern', '-outdir', 'kolodkin6',
...
setup(
    name='kolodkin6',
    version='0.1.0',
    description='AMICI-generated module for model kolodkin6',
