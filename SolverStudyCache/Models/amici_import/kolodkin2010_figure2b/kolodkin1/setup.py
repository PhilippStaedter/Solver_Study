...
sources = ['swig/kolodkin1.i', *getModelSources()]
...
# Build shared object
model_module = Extension('kolodkin1._kolodkin1',
                         sources=sources,
                         ...
                         swig_opts=['-c++', '-modern', '-outdir', 'kolodkin1',
...
setup(
    name='kolodkin1',
    version='0.1.0',
    description='AMICI-generated module for model kolodkin1',
