...
sources = ['swig/model0_marhl.i', *getModelSources()]
...
# Build shared object
model_module = Extension('model0_marhl._model0_marhl',
                         sources=sources,
                         ...
                         swig_opts=['-c++', '-modern', '-outdir', 'model0_marhl',
...
setup(
    name='model0_marhl',
    version='0.1.0',
    description='AMICI-generated module for model model0_marhl',
