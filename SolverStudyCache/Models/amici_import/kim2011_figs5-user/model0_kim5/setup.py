...
sources = ['swig/model0_kim5.i', *getModelSources()]
...
# Build shared object
model_module = Extension('model0_kim5._model0_kim5',
                         sources=sources,
                         ...
                         swig_opts=['-c++', '-modern', '-outdir', 'model0_kim5',
...
setup(
    name='model0_kim5',
    version='0.1.0',
    description='AMICI-generated module for model model0_kim5',
