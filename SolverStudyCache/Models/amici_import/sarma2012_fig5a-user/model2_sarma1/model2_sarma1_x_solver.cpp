...
void x_solver_model2_sarma1(realtype *x_solver, const realtype *x_rdata){
    ...
    x_solver[20] = species_3;
    x_solver[21] = species_4;
    x_solver[22] = species_5;
    x_solver[23] = species_6;
    x_solver[24] = species_7;
    x_solver[25] = species_8;
    x_solver[26] = species_9;
}