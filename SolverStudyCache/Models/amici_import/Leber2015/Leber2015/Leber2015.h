 ...
 * @return
 */
extern void J_Leber2015(realtype *J, const realtype t, const realtype *x,
                            const realtype *p, const realtype *k,
                            const realtype *h, const realtype *w,
                            const realtype *dwdx);
extern void JB_Leber2015(realtype *JB, const realtype t, const realtype *x,
                             const realtype *p, const realtype *k,
                             const realtype *h, const realtype *xB,
                             const realtype *w, const realtype *dwdx);
extern void JDiag_Leber2015(realtype *JDiag, const realtype t,
                                const realtype *x, const realtype *p,
                                const realtype *k, const realtype *h,
                                const realtype *w, const realtype *dwdx);
extern void JSparse_Leber2015(realtype *JSparse, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *dwdx);
extern void JSparse_colptrs_Leber2015(sunindextype *colptrs);
extern void JSparse_rowvals_Leber2015(sunindextype *rowvals);
extern void JSparseB_Leber2015(realtype *JSparseB, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *xB, const realtype *w, const realtype *dwdx);
extern void JSparseB_colptrs_Leber2015(sunindextype *colptrs);
extern void JSparseB_rowvals_Leber2015(sunindextype *rowvals);
extern void Jy_Leber2015(realtype *nllh, const int iy, const realtype *p,
                             const realtype *k, const realtype *y,
                             const realtype *sigmay, const realtype *my);
extern void dJydsigmay_Leber2015(realtype *dJydsigmay, const int iy,
                                     const realtype *p, const realtype *k,
                                     const realtype *y, const realtype *sigmay,
                                     const realtype *my);
extern void dJydy_Leber2015(realtype *dJydy, const int iy, const realtype *p, const realtype *k, const realtype *y, const realtype *sigmay, const realtype *my);
extern void dJydy_colptrs_Leber2015(sunindextype *colptrs, int index);
extern void dJydy_rowvals_Leber2015(sunindextype *rowvals, int index);
extern void dwdp_Leber2015(realtype *dwdp, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *tcl, const realtype *dtcldp, const int ip);
extern void dwdx_Leber2015(realtype *dwdx, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *tcl);
extern void dwdx_colptrs_Leber2015(sunindextype *colptrs);
extern void dwdx_rowvals_Leber2015(sunindextype *rowvals);
extern void dxdotdw_Leber2015(realtype *dxdotdw, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w);
extern void dxdotdw_colptrs_Leber2015(sunindextype *colptrs);
extern void dxdotdw_rowvals_Leber2015(sunindextype *rowvals);
extern void dxdotdp_Leber2015(realtype *dxdotdp, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const int ip, const realtype *w);
extern void dydx_Leber2015(realtype *dydx, const realtype t,
                               const realtype *x, const realtype *p,
                               const realtype *k, const realtype *h,
                               const realtype *w, const realtype *dwdx);
extern void dydp_Leber2015(realtype *dydp, const realtype t,
                               const realtype *x, const realtype *p,
                               const realtype *k, const realtype *h,
                               const int ip, const realtype *w,
                               const realtype *dwp);
extern void dsigmaydp_Leber2015(realtype *dsigmaydp, const realtype t,
                                    const realtype *p, const realtype *k,
                                    const int ip);
extern void sigmay_Leber2015(realtype *sigmay, const realtype t,
                                 const realtype *p, const realtype *k);
extern void w_Leber2015(realtype *w, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *tcl);
extern void x0_Leber2015(realtype *x0, const realtype t, const realtype *p,
                             const realtype *k);
extern void x0_fixedParameters_Leber2015(realtype *x0, const realtype t,
                                             const realtype *p,
                                             const realtype *k);
extern void sx0_Leber2015(realtype *sx0, const realtype t,
                              const realtype *x0, const realtype *p,
                              const realtype *k, const int ip);
extern void sx0_fixedParameters_Leber2015(realtype *sx0, const realtype t,
                                              const realtype *x0,
                                              const realtype *p,
                                              const realtype *k, const int ip);
extern void xdot_Leber2015(realtype *xdot, const realtype t,
                               const realtype *x, const realtype *p,
                               const realtype *k, const realtype *h,
                               const realtype *w);
extern void y_Leber2015(realtype *y, const realtype t, const realtype *x,
                            const realtype *p, const realtype *k,
                            const realtype *h, const realtype *w);

extern void x_solver_Leber2015(realtype *x_solver, const realtype *x_rdata);
extern void total_cl_Leber2015(realtype *total_cl, const realtype *x_rdata);

/**
 * @brief AMICI-generated model subclass.
 */
class Model_Leber2015 : public amici::Model_ODE {
  public:
    /**
    ...
    Model_Leber2015()
        : amici::Model_ODE(
              ...
              std::vector<realtype>{0.5069887, 1.72495199303666e-05, 2.39665140586358, 0.99505694359, 2.35932924820229e-07, 62.5911647602982, 2.3381277077344e-06, 1.1e-05, 1.59920673150176e-06, 10.5, 0.55, 0.102702503781515, 594.896546415159, 6.27092296294148e-10, 0.129717307334483, 0.171190728888258, 0.120935308788409, 5.29827880572231e-05, 5e-11, 5.5, 1.459, 0.0020401460213434, 1.27393226093773, 2.50454427171444, 0.000171079818745428, 1.16013457036959e-06, 0.0106698310809694, 0.006, 0.065, 0.092308585205372, 2.0, 4.5e-05, 20.0, 0.156287382551622, 4.5e-10, 4000.0, 26.8747332769592, 559.297141527983, 0.0002, 3.65, 0.00095, 2255.80469507059, 0.0648415756801505, 9.65568121975566e-05, 0.0430096, 53.9130568911728, 0.18, 0.00478, 2.33225e-05, 0.0933277452272273, 2.5},       // dynamic parameters
    ...
    virtual amici::Model *clone() const override {
        return new Model_Leber2015(*this);
    }
    ...
    virtual void fJ(realtype *J, const realtype t, const realtype *x,
        ...
        J_Leber2015(J, t, x, p, k, h, w, dwdx);
    }
    ...
    virtual void fJB(realtype *JB, const realtype t, const realtype *x,
        ...
        JB_Leber2015(JB, t, x, p, k, h, xB, w, dwdx);
    }
    ...
    virtual void fJDiag(realtype *JDiag, const realtype t, const realtype *x,
                        const realtype *p, const realtype *k, const realtype *h,
                        const realtype *w, const realtype *dwdx) override {
        JDiag_Leber2015(JDiag, t, x, p, k, h, w, dwdx);
    }
    ...
    virtual void fJy(realtype *nllh, const int iy, const realtype *p,
        ...
        Jy_Leber2015(nllh, iy, p, k, y, sigmay, my);
    }
    ...
    virtual void fdJydsigma(realtype *dJydsigma, const int iy,
        ...
        dJydsigmay_Leber2015(dJydsigma, iy, p, k, y, sigmay, my);
    }
    ...
    virtual void fdsigmaydp(realtype *dsigmaydp, const realtype t,
        ...
        dsigmaydp_Leber2015(dsigmaydp, t, p, k, ip);
    }
    ...
    virtual void fdwdp(realtype *dwdp, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *tcl, const realtype *dtcldp, const int ip) override {
        dwdp_Leber2015( dwdp,  t,  x,  p,  k,  h,  w,  tcl,  dtcldp,  ip);
    }
    ...
    virtual void fdwdx(realtype *dwdx, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *tcl) override {
        dwdx_Leber2015( dwdx,  t,  x,  p,  k,  h,  w,  tcl);
    }
    ...
    virtual void fdxdotdp(realtype *dxdotdp, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const int ip, const realtype *w) override {
        dxdotdp_Leber2015( dxdotdp,  t,  x,  p,  k,  h,  ip,  w);
    }
    ...
    virtual void fdydx(realtype *dydx, const realtype t, const realtype *x,
                       const realtype *p, const realtype *k, const realtype *h,
                       const realtype *w, const realtype *dwdx) override {
        dydx_Leber2015(dydx, t, x, p, k, h, w, dwdx);
    }
    ...
    virtual void fdydp(realtype *dydp, const realtype t, const realtype *x,
        ...
        dydp_Leber2015(dydp, t, x, p, k, h, ip, w, dwdp);
    }
    ...
    virtual void fsx0_fixedParameters(realtype *sx0, const realtype t,
                                      ...
                                      const realtype *k,
                                      const int ip) override {
        sx0_fixedParameters_Leber2015(sx0, t, x0, p, k, ip);
    }
    ...
    virtual void fx0_fixedParameters(realtype *x0, const realtype t,
                                     const realtype *p,
                                     const realtype *k) override {
        x0_fixedParameters_Leber2015(x0, t, p, k);
    }
    ...
    virtual void fxdot(realtype *xdot, const realtype t, const realtype *x,
        ...
        xdot_Leber2015(xdot, t, x, p, k, h, w);
    }
...
"k1",};
    ...
    virtual std::vector<std::string> getStateNames() const override {
        return std::vector<std::string>{"Cdiff",
...
"x22",};
    ...
    virtual std::vector<std::string> getParameterIds() const override {
        return std::vector<std::string>{"Treg_Degradation_k1",
"eDC_Degradation_k1",
"Th17_Degradation_k1",
"Th1_Degradation_k1",
"N_Degradation_K",
...
"Cdiff_Death_m2",
"Cdiff_Death_K",
"N_Activation_Migration_k3",
"N_Activation_Migration_k2",
"N_Activation_Migration_k1",
"N_Activation_Migration_v",
"Cdiff_Growth_K",
"Treg_Migration_k1",
"Th1_Migration_k1",
"Th17_Plasticity_k2",
...
"M_Activation_K",
"M_Death_k1",
"Commensal_Regrowth_k2",
"Commensal_Regrowth_k1",
"E_Heal_k1",
"tDC_Production_k2",
"tDC_Production_k1",
"tDC_Production_K",
"tDC_Migration_k1",
"tDC_Degradation_k",
"Th17_Differentiation_k1",
"Th1_Differentiation_k1",
"Th1_Differentiation_k2",
"Th1_Differentiation_K",
"Treg_Differentiation_k1",
"Commensal_Harmful_Death_A2",
"Commensal_Harmful_Death_A1",
"Commensal_Harmful_Death_K",
"Commensal_Death_k1",
"E_i_Natural_Death_k1",};
    }
