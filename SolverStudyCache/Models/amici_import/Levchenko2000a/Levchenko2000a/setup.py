...
sources = ['swig/Levchenko2000a.i', *getModelSources()]
...
# Build shared object
model_module = Extension('Levchenko2000a._Levchenko2000a',
                         sources=sources,
                         ...
                         swig_opts=['-c++', '-modern', '-outdir', 'Levchenko2000a',
...
setup(
    name='Levchenko2000a',
    version='0.1.0',
    description='AMICI-generated module for model Levchenko2000a',
