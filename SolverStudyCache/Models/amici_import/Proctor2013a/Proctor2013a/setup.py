...
sources = ['swig/Proctor2013a.i', *getModelSources()]
...
# Build shared object
model_module = Extension('Proctor2013a._Proctor2013a',
                         sources=sources,
                         ...
                         swig_opts=['-c++', '-modern', '-outdir', 'Proctor2013a',
...
setup(
    name='Proctor2013a',
    version='0.1.0',
    description='AMICI-generated module for model Proctor2013a',
