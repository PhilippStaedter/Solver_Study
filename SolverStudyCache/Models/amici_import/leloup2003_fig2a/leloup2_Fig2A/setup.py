...
sources = ['swig/leloup2_Fig2A.i', *getModelSources()]
...
# Build shared object
model_module = Extension('leloup2_Fig2A._leloup2_Fig2A',
                         sources=sources,
                         ...
                         swig_opts=['-c++', '-modern', '-outdir', 'leloup2_Fig2A',
...
setup(
    name='leloup2_Fig2A',
    version='0.1.0',
    description='AMICI-generated module for model leloup2_Fig2A',
