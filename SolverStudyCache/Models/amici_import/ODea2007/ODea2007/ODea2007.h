 ...
 * @return
 */
extern void J_ODea2007(realtype *J, const realtype t, const realtype *x,
                            const realtype *p, const realtype *k,
                            const realtype *h, const realtype *w,
                            const realtype *dwdx);
extern void JB_ODea2007(realtype *JB, const realtype t, const realtype *x,
                             const realtype *p, const realtype *k,
                             const realtype *h, const realtype *xB,
                             const realtype *w, const realtype *dwdx);
extern void JDiag_ODea2007(realtype *JDiag, const realtype t,
                                const realtype *x, const realtype *p,
                                const realtype *k, const realtype *h,
                                const realtype *w, const realtype *dwdx);
extern void JSparse_ODea2007(realtype *JSparse, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *dwdx);
extern void JSparse_colptrs_ODea2007(sunindextype *colptrs);
extern void JSparse_rowvals_ODea2007(sunindextype *rowvals);
extern void JSparseB_ODea2007(realtype *JSparseB, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *xB, const realtype *w, const realtype *dwdx);
extern void JSparseB_colptrs_ODea2007(sunindextype *colptrs);
extern void JSparseB_rowvals_ODea2007(sunindextype *rowvals);
extern void Jy_ODea2007(realtype *nllh, const int iy, const realtype *p,
                             const realtype *k, const realtype *y,
                             const realtype *sigmay, const realtype *my);
extern void dJydsigmay_ODea2007(realtype *dJydsigmay, const int iy,
                                     const realtype *p, const realtype *k,
                                     const realtype *y, const realtype *sigmay,
                                     const realtype *my);
extern void dJydy_ODea2007(realtype *dJydy, const int iy, const realtype *p, const realtype *k, const realtype *y, const realtype *sigmay, const realtype *my);
extern void dJydy_colptrs_ODea2007(sunindextype *colptrs, int index);
extern void dJydy_rowvals_ODea2007(sunindextype *rowvals, int index);
extern void dwdp_ODea2007(realtype *dwdp, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *tcl, const realtype *dtcldp, const int ip);
extern void dwdx_ODea2007(realtype *dwdx, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *tcl);
extern void dwdx_colptrs_ODea2007(sunindextype *colptrs);
extern void dwdx_rowvals_ODea2007(sunindextype *rowvals);
extern void dxdotdw_ODea2007(realtype *dxdotdw, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w);
extern void dxdotdw_colptrs_ODea2007(sunindextype *colptrs);
extern void dxdotdw_rowvals_ODea2007(sunindextype *rowvals);
extern void dxdotdp_ODea2007(realtype *dxdotdp, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const int ip, const realtype *w);
extern void dydx_ODea2007(realtype *dydx, const realtype t,
                               const realtype *x, const realtype *p,
                               const realtype *k, const realtype *h,
                               const realtype *w, const realtype *dwdx);
extern void dydp_ODea2007(realtype *dydp, const realtype t,
                               const realtype *x, const realtype *p,
                               const realtype *k, const realtype *h,
                               const int ip, const realtype *w,
                               const realtype *dwp);
extern void dsigmaydp_ODea2007(realtype *dsigmaydp, const realtype t,
                                    const realtype *p, const realtype *k,
                                    const int ip);
extern void sigmay_ODea2007(realtype *sigmay, const realtype t,
                                 const realtype *p, const realtype *k);
extern void w_ODea2007(realtype *w, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *tcl);
extern void x0_ODea2007(realtype *x0, const realtype t, const realtype *p,
                             const realtype *k);
extern void x0_fixedParameters_ODea2007(realtype *x0, const realtype t,
                                             const realtype *p,
                                             const realtype *k);
extern void sx0_ODea2007(realtype *sx0, const realtype t,
                              const realtype *x0, const realtype *p,
                              const realtype *k, const int ip);
extern void sx0_fixedParameters_ODea2007(realtype *sx0, const realtype t,
                                              const realtype *x0,
                                              const realtype *p,
                                              const realtype *k, const int ip);
extern void xdot_ODea2007(realtype *xdot, const realtype t,
                               const realtype *x, const realtype *p,
                               const realtype *k, const realtype *h,
                               const realtype *w);
extern void y_ODea2007(realtype *y, const realtype t, const realtype *x,
                            const realtype *p, const realtype *k,
                            const realtype *h, const realtype *w);

extern void x_solver_ODea2007(realtype *x_solver, const realtype *x_rdata);
extern void total_cl_ODea2007(realtype *total_cl, const realtype *x_rdata);

/**
 * @brief AMICI-generated model subclass.
 */
class Model_ODea2007 : public amici::Model_ODE {
  public:
    /**
    ...
    Model_ODea2007()
        : amici::Model_ODE(
              ...
              std::vector<realtype>{0.0001848, 0.0168, 0.2448, 0.075, 1.35, 6e-05, 30.0, 6e-05, 30.0, 0.075, 11.1, 6e-05, 30.0, 0.12, 0.12, 6e-05, 6e-05, 0.072, 0.36, 0.012, 0.018, 0.828, 0.414, 0.012, 0.018, 0.12, 0.024, 6e-05, 6e-05, 0.18, 0.18, 6e-05, 30.0, 0.105, 2.88, 6e-05, 30.0, 6e-05, 30.0, 0.105, 0.36, 0.2448, 0.0168, 4.272e-05, 0.0048, 5.4, 3.048e-05, 0.0168, 0.2448, 0.105, 0.54, 6e-05, 30.0, 6e-05, 30.0, 0.105, 4.2, 6e-05, 30.0, 0.18, 0.18, 6e-05, 6e-05, 0.036, 0.18, 0.012, 0.018, 0.414, 0.0, 1.98},       // dynamic parameters
    ...
    virtual amici::Model *clone() const override {
        return new Model_ODea2007(*this);
    }
    ...
    virtual void fJB(realtype *JB, const realtype t, const realtype *x,
        ...
        JB_ODea2007(JB, t, x, p, k, h, xB, w, dwdx);
    }
    ...
    virtual void fJDiag(realtype *JDiag, const realtype t, const realtype *x,
                        const realtype *p, const realtype *k, const realtype *h,
                        const realtype *w, const realtype *dwdx) override {
        JDiag_ODea2007(JDiag, t, x, p, k, h, w, dwdx);
    }
    ...
    virtual void fJy(realtype *nllh, const int iy, const realtype *p,
        ...
        Jy_ODea2007(nllh, iy, p, k, y, sigmay, my);
    }
    ...
    virtual void fdJydsigma(realtype *dJydsigma, const int iy,
        ...
        dJydsigmay_ODea2007(dJydsigma, iy, p, k, y, sigmay, my);
    }
    ...
    virtual void fdsigmaydp(realtype *dsigmaydp, const realtype t,
        ...
        dsigmaydp_ODea2007(dsigmaydp, t, p, k, ip);
    }
    ...
    virtual void fdwdp(realtype *dwdp, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *tcl, const realtype *dtcldp, const int ip) override {
        dwdp_ODea2007( dwdp,  t,  x,  p,  k,  h,  w,  tcl,  dtcldp,  ip);
    }
    ...
    virtual void fdwdx(realtype *dwdx, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *tcl) override {
        dwdx_ODea2007( dwdx,  t,  x,  p,  k,  h,  w,  tcl);
    }
    ...
    virtual void fdxdotdp(realtype *dxdotdp, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const int ip, const realtype *w) override {
        dxdotdp_ODea2007( dxdotdp,  t,  x,  p,  k,  h,  ip,  w);
    }
    ...
    virtual void fdydx(realtype *dydx, const realtype t, const realtype *x,
                       const realtype *p, const realtype *k, const realtype *h,
                       const realtype *w, const realtype *dwdx) override {
        dydx_ODea2007(dydx, t, x, p, k, h, w, dwdx);
    }
    ...
    virtual void fdydp(realtype *dydp, const realtype t, const realtype *x,
        ...
        dydp_ODea2007(dydp, t, x, p, k, h, ip, w, dwdp);
    }
    ...
    virtual void fsx0_fixedParameters(realtype *sx0, const realtype t,
                                      ...
                                      const realtype *k,
                                      const int ip) override {
        sx0_fixedParameters_ODea2007(sx0, t, x0, p, k, ip);
    }
    ...
    virtual void fx0_fixedParameters(realtype *x0, const realtype t,
                                     const realtype *p,
                                     const realtype *k) override {
        x0_fixedParameters_ODea2007(x0, t, p, k);
    }
    ...
    virtual void fxdot(realtype *xdot, const realtype t, const realtype *x,
        ...
        xdot_ODea2007(xdot, t, x, p, k, h, w);
    }
    ...
    virtual std::vector<std::string> getParameterNames() const override {
        return std::vector<std::string>{"tr2a",
"tr3a",
"tr1a",
"d1_1",
"a1",
...
"tr2a_i",};
    ...
    virtual std::vector<std::string> getStateNames() const override {
        return std::vector<std::string>{"IkBat",
"IkBa",
"IkBan",
"IkBaIKK",
"IkBaNFkB",
...
"x23",};
    ...
    virtual std::vector<std::string> getParameterIds() const override {
        return std::vector<std::string>{"txn_a_tr2a",
"mdeg_a_tr3a",
"tsl_a_tr1a",
"int_ai_d1_1",
"int_ai_a1",
...
"itxn_a_tr2a_i",};
    ...
    virtual std::vector<std::string> getStateIds() const override {
        return std::vector<std::string>{"IkBa_mRNA",
"IkBa_cytoplasm",
"IkBa_nucleus",
"IkBaIKK",
"IkBaNFkB_cytoplasm",
