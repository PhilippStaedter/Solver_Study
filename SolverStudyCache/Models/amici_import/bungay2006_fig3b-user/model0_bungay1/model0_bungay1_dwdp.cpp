...
void dwdp_model0_bungay1(realtype *dwdp, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *tcl, const realtype *dtcldp, const int ip){
    switch(ip) {
        case 0:
            dwdp[17] = 1.0*TF_l*VIIa_l;
            break;
        case 1:
            dwdp[59] = 1.0*TF_VIIa_X_l;
            break;
        case 2:
            dwdp[61] = 1.0*TF_VII_l*Xa_l;
            break;
        case 3:
            dwdp[61] = -1.0*TF_VII_Xa_l;
            break;
        case 4:
            dwdp[62] = 1.0*TF_VII_Xa_l;
            break;
        case 5:
            dwdp[63] = 1.0*IXa_l*VIIIa_l;
            break;
        case 6:
            dwdp[63] = -1.0*IXa_VIIIa_l;
            break;
        case 7:
            dwdp[64] = 1.0*Va_l*Xa_l;
            break;
        case 8:
            dwdp[64] = -1.0*Xa_Va_l;
            break;
        case 9:
            dwdp[65] = 1.0*IXa_VIIIa_l*X_l;
            break;
        case 10:
            dwdp[65] = -1.0*IXa_VIIIa_X_l;
            break;
        case 11:
            dwdp[17] = -1.0*TF_VIIa_l;
            break;
        case 12:
            dwdp[66] = 1.0*IXa_VIIIa_X_l;
            break;
        case 13:
            dwdp[67] = 1.0*V_l*Xa_l;
            break;
        case 14:
            dwdp[67] = -1.0*V_Xa_l;
            break;
        ...
        case 71:
            ...
            break;
        case 72:
            dwdp[60] = 1.0*TF_VIIa_Xa_l;
            break;
        case 73:
            dwdp[54] = 1.0*AT_f*XIa_l;
            break;
        case 74:
            dwdp[55] = 1.0*IIa_f*alpha2M_l;
            break;
        case 75:
            dwdp[56] = 1.0*Xa_f*alpha2M_l;
            break;
        case 76:
            dwdp[58] = 1.0*TF_VIIa_l*X_l;
            break;
        case 77:
            dwdp[58] = -1.0*TF_VIIa_X_l;
            break;
        case 78:
            dwdp[4] = -1.0*APC_l;
            break;
