...
sources = ['swig/model4_mellor1.i', *getModelSources()]
...
# Build shared object
model_module = Extension('model4_mellor1._model4_mellor1',
                         sources=sources,
                         ...
                         swig_opts=['-c++', '-modern', '-outdir', 'model4_mellor1',
...
setup(
    name='model4_mellor1',
    version='0.1.0',
    description='AMICI-generated module for model model4_mellor1',
