...
sources = ['swig/model0_lee3.i', *getModelSources()]
...
# Build shared object
model_module = Extension('model0_lee3._model0_lee3',
                         sources=sources,
                         ...
                         swig_opts=['-c++', '-modern', '-outdir', 'model0_lee3',
...
setup(
    name='model0_lee3',
    version='0.1.0',
    description='AMICI-generated module for model model0_lee3',
