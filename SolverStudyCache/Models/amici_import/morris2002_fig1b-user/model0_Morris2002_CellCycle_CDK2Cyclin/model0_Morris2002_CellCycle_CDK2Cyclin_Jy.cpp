...
void Jy_model0_Morris2002_CellCycle_CDK2Cyclin(realtype *Jy, const int iy, const realtype *p, const realtype *k, const realtype *y, const realtype *sigmay, const realtype *my){
    switch(iy) {
        case 0:
