...
sources = ['swig/model0_Morris2002_CellCycle_CDK2Cyclin.i', *getModelSources()]
...
# Build shared object
model_module = Extension('model0_Morris2002_CellCycle_CDK2Cyclin._model0_Morris2002_CellCycle_CDK2Cyclin',
                         sources=sources,
                         ...
                         swig_opts=['-c++', '-modern', '-outdir', 'model0_Morris2002_CellCycle_CDK2Cyclin',
...
# Install
setup(
    name='model0_Morris2002_CellCycle_CDK2Cyclin',
    version='0.1.0',
    description='AMICI-generated module for model model0_Morris2002_CellCycle_CDK2Cyclin',
