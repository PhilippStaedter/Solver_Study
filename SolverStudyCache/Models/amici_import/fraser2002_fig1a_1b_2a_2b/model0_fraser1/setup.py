...
sources = ['swig/model0_fraser1.i', *getModelSources()]
...
# Build shared object
model_module = Extension('model0_fraser1._model0_fraser1',
                         sources=sources,
                         ...
                         swig_opts=['-c++', '-modern', '-outdir', 'model0_fraser1',
...
setup(
    name='model0_fraser1',
    version='0.1.0',
    description='AMICI-generated module for model model0_fraser1',
