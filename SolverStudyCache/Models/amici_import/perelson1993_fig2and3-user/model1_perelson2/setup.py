...
sources = ['swig/model1_perelson2.i', *getModelSources()]
...
# Build shared object
model_module = Extension('model1_perelson2._model1_perelson2',
                         sources=sources,
                         ...
                         swig_opts=['-c++', '-modern', '-outdir', 'model1_perelson2',
...
# Install
setup(
    name='model1_perelson2',
    version='0.1.0',
    description='AMICI-generated module for model model1_perelson2',
