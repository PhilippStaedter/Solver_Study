...
sources = ['swig/model0_ma.i', *getModelSources()]
...
# Build shared object
model_module = Extension('model0_ma._model0_ma',
                         sources=sources,
                         ...
                         swig_opts=['-c++', '-modern', '-outdir', 'model0_ma',
...
setup(
    name='model0_ma',
    version='0.1.0',
    description='AMICI-generated module for model model0_ma',
