...
sources = ['swig/model3_hockin1.i', *getModelSources()]
...
# Build shared object
model_module = Extension('model3_hockin1._model3_hockin1',
                         sources=sources,
                         ...
                         swig_opts=['-c++', '-modern', '-outdir', 'model3_hockin1',
...
setup(
    name='model3_hockin1',
    version='0.1.0',
    description='AMICI-generated module for model model3_hockin1',
