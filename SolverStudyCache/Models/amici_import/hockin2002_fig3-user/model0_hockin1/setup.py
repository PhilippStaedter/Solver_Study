...
sources = ['swig/model0_hockin1.i', *getModelSources()]
...
# Build shared object
model_module = Extension('model0_hockin1._model0_hockin1',
                         sources=sources,
                         ...
                         swig_opts=['-c++', '-modern', '-outdir', 'model0_hockin1',
...
setup(
    name='model0_hockin1',
    version='0.1.0',
    description='AMICI-generated module for model model0_hockin1',
