...
sources = ['swig/model2_hockin1.i', *getModelSources()]
...
# Build shared object
model_module = Extension('model2_hockin1._model2_hockin1',
                         sources=sources,
                         ...
                         swig_opts=['-c++', '-modern', '-outdir', 'model2_hockin1',
...
setup(
    name='model2_hockin1',
    version='0.1.0',
    description='AMICI-generated module for model model2_hockin1',
