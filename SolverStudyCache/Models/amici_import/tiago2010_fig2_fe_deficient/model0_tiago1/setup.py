...
sources = ['swig/model0_tiago1.i', *getModelSources()]
...
# Build shared object
model_module = Extension('model0_tiago1._model0_tiago1',
                         sources=sources,
                         ...
                         swig_opts=['-c++', '-modern', '-outdir', 'model0_tiago1',
...
setup(
    name='model0_tiago1',
    version='0.1.0',
    description='AMICI-generated module for model model0_tiago1',
