...
sources = ['swig/model0_kholodenko1.i', *getModelSources()]
...
# Build shared object
model_module = Extension('model0_kholodenko1._model0_kholodenko1',
                         sources=sources,
                         ...
                         swig_opts=['-c++', '-modern', '-outdir', 'model0_kholodenko1',
...
# Install
setup(
    name='model0_kholodenko1',
    version='0.1.0',
    description='AMICI-generated module for model model0_kholodenko1',
