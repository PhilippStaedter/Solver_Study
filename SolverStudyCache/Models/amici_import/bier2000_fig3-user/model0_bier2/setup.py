...
sources = ['swig/model0_bier2.i', *getModelSources()]
...
# Build shared object
model_module = Extension('model0_bier2._model0_bier2',
                         sources=sources,
                         ...
                         swig_opts=['-c++', '-modern', '-outdir', 'model0_bier2',
...
setup(
    name='model0_bier2',
    version='0.1.0',
    description='AMICI-generated module for model model0_bier2',
