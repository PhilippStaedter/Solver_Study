...
sources = ['swig/model0_essunger3.i', *getModelSources()]
...
# Build shared object
model_module = Extension('model0_essunger3._model0_essunger3',
                         sources=sources,
                         ...
                         swig_opts=['-c++', '-modern', '-outdir', 'model0_essunger3',
...
# Install
setup(
    name='model0_essunger3',
    version='0.1.0',
    description='AMICI-generated module for model model0_essunger3',
