 ...
 * @return
 */
extern void J_Liu2011(realtype *J, const realtype t, const realtype *x,
                            const realtype *p, const realtype *k,
                            const realtype *h, const realtype *w,
                            const realtype *dwdx);
extern void JB_Liu2011(realtype *JB, const realtype t, const realtype *x,
                             const realtype *p, const realtype *k,
                             const realtype *h, const realtype *xB,
                             const realtype *w, const realtype *dwdx);
extern void JDiag_Liu2011(realtype *JDiag, const realtype t,
                                const realtype *x, const realtype *p,
                                const realtype *k, const realtype *h,
                                const realtype *w, const realtype *dwdx);
extern void JSparse_Liu2011(realtype *JSparse, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *dwdx);
extern void JSparse_colptrs_Liu2011(sunindextype *colptrs);
extern void JSparse_rowvals_Liu2011(sunindextype *rowvals);
extern void JSparseB_Liu2011(realtype *JSparseB, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *xB, const realtype *w, const realtype *dwdx);
extern void JSparseB_colptrs_Liu2011(sunindextype *colptrs);
extern void JSparseB_rowvals_Liu2011(sunindextype *rowvals);
extern void Jy_Liu2011(realtype *nllh, const int iy, const realtype *p,
                             const realtype *k, const realtype *y,
                             const realtype *sigmay, const realtype *my);
extern void dJydsigmay_Liu2011(realtype *dJydsigmay, const int iy,
                                     const realtype *p, const realtype *k,
                                     const realtype *y, const realtype *sigmay,
                                     const realtype *my);
extern void dJydy_Liu2011(realtype *dJydy, const int iy, const realtype *p, const realtype *k, const realtype *y, const realtype *sigmay, const realtype *my);
extern void dJydy_colptrs_Liu2011(sunindextype *colptrs, int index);
extern void dJydy_rowvals_Liu2011(sunindextype *rowvals, int index);
extern void dwdp_Liu2011(realtype *dwdp, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *tcl, const realtype *dtcldp, const int ip);
extern void dwdx_Liu2011(realtype *dwdx, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *tcl);
extern void dwdx_colptrs_Liu2011(sunindextype *colptrs);
extern void dwdx_rowvals_Liu2011(sunindextype *rowvals);
extern void dxdotdw_Liu2011(realtype *dxdotdw, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w);
extern void dxdotdw_colptrs_Liu2011(sunindextype *colptrs);
extern void dxdotdw_rowvals_Liu2011(sunindextype *rowvals);
extern void dxdotdp_Liu2011(realtype *dxdotdp, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const int ip, const realtype *w);
extern void dydx_Liu2011(realtype *dydx, const realtype t,
                               const realtype *x, const realtype *p,
                               const realtype *k, const realtype *h,
                               const realtype *w, const realtype *dwdx);
extern void dydp_Liu2011(realtype *dydp, const realtype t,
                               const realtype *x, const realtype *p,
                               const realtype *k, const realtype *h,
                               const int ip, const realtype *w,
                               const realtype *dwp);
extern void dsigmaydp_Liu2011(realtype *dsigmaydp, const realtype t,
                                    const realtype *p, const realtype *k,
                                    const int ip);
extern void sigmay_Liu2011(realtype *sigmay, const realtype t,
                                 const realtype *p, const realtype *k);
extern void w_Liu2011(realtype *w, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *tcl);
extern void x0_Liu2011(realtype *x0, const realtype t, const realtype *p,
                             const realtype *k);
extern void x0_fixedParameters_Liu2011(realtype *x0, const realtype t,
                                             const realtype *p,
                                             const realtype *k);
extern void sx0_Liu2011(realtype *sx0, const realtype t,
                              const realtype *x0, const realtype *p,
                              const realtype *k, const int ip);
extern void sx0_fixedParameters_Liu2011(realtype *sx0, const realtype t,
                                              const realtype *x0,
                                              const realtype *p,
                                              const realtype *k, const int ip);
extern void xdot_Liu2011(realtype *xdot, const realtype t,
                               const realtype *x, const realtype *p,
                               const realtype *k, const realtype *h,
                               const realtype *w);
extern void y_Liu2011(realtype *y, const realtype t, const realtype *x,
                            const realtype *p, const realtype *k,
                            const realtype *h, const realtype *w);

extern void x_solver_Liu2011(realtype *x_solver, const realtype *x_rdata);
extern void total_cl_Liu2011(realtype *total_cl, const realtype *x_rdata);

/**
 * @brief AMICI-generated model subclass.
 */
class Model_Liu2011 : public amici::Model_ODE {
  public:
    /**
    ...
    Model_Liu2011()
        : amici::Model_ODE(
              ...
              std::vector<realtype>{0.0275999, 0.0109, 0.00074, 0.0011, 2.0, 10.5, 0.64564661669102, 0.194551104058408, 0.000591152775857994, 0.414004459949002, 0.99647572245388, 0.977836567576895, 500.0, 2500.0, 0.1, 0.0368010796682635, 66.3776807395383, 829.115813389061, 0.091011109910329, 0.0508205528375529, 0.0368010796682635, 0.1, 66.3776807395383, 829.115813389061, 1.1, 2000.0, 0.199162432258527, 7.07e-05, 7.23e-05, 1.1, 2000.0, 7.07e-05, 0.0001, 0.00074, 0.0011, 2.0, 500.0, 10.5, 2500.0, 0.969998277173144, 0.069020578737621, 0.969998277173144, 0.069020578737621, 0.0613537204215846, 0.983691204042155, 0.613416050428938, 0.980777558937884, 0.613416050428938, 0.983691204042155, 0.613416050428938, 0.983691204042155, 0.00074, 0.0011, 2.0, 500.0, 10.5, 2500.0, 0.0368010796682635, 0.1, 66.3776807395383, 829.115813389061, 1.1, 2000.0, 0.0368010796682635, 0.1, 0.00074, 0.0011, 71.1705760475931, 3796.22684377655, 38.9625903487667, 5972.30640657865, 0.091011109910329, 0.0508205528375529, 0.0368010796682635, 0.1, 66.3776807395383, 829.115813389061, 1.1, 2000.0, 0.000342266, 0.492901, 0.0470911, 0.0, 0.0, 0.000342266, 0.492901, 0.0470911, 0.0, 0.0},       // dynamic parameters
    ...
    virtual void fJB(realtype *JB, const realtype t, const realtype *x,
        ...
        JB_Liu2011(JB, t, x, p, k, h, xB, w, dwdx);
    }
    ...
    virtual void fJDiag(realtype *JDiag, const realtype t, const realtype *x,
                        const realtype *p, const realtype *k, const realtype *h,
                        const realtype *w, const realtype *dwdx) override {
        JDiag_Liu2011(JDiag, t, x, p, k, h, w, dwdx);
    }
    ...
    virtual void fJy(realtype *nllh, const int iy, const realtype *p,
        ...
        Jy_Liu2011(nllh, iy, p, k, y, sigmay, my);
    }
    ...
    virtual void fdJydsigma(realtype *dJydsigma, const int iy,
        ...
        dJydsigmay_Liu2011(dJydsigma, iy, p, k, y, sigmay, my);
    }
    ...
    virtual void fdsigmaydp(realtype *dsigmaydp, const realtype t,
        ...
        dsigmaydp_Liu2011(dsigmaydp, t, p, k, ip);
    }
    ...
    virtual void fdwdp(realtype *dwdp, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *tcl, const realtype *dtcldp, const int ip) override {
        dwdp_Liu2011( dwdp,  t,  x,  p,  k,  h,  w,  tcl,  dtcldp,  ip);
    }
    ...
    virtual void fdwdx(realtype *dwdx, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *tcl) override {
        dwdx_Liu2011( dwdx,  t,  x,  p,  k,  h,  w,  tcl);
    }
    ...
    virtual void fdxdotdp(realtype *dxdotdp, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const int ip, const realtype *w) override {
        dxdotdp_Liu2011( dxdotdp,  t,  x,  p,  k,  h,  ip,  w);
    }
    ...
    virtual void fdydx(realtype *dydx, const realtype t, const realtype *x,
                       const realtype *p, const realtype *k, const realtype *h,
                       const realtype *w, const realtype *dwdx) override {
        dydx_Liu2011(dydx, t, x, p, k, h, w, dwdx);
    }
    ...
    virtual void fdydp(realtype *dydp, const realtype t, const realtype *x,
        ...
        dydp_Liu2011(dydp, t, x, p, k, h, ip, w, dwdp);
    }
    ...
    virtual void fsx0_fixedParameters(realtype *sx0, const realtype t,
                                      ...
                                      const realtype *k,
                                      const int ip) override {
        sx0_fixedParameters_Liu2011(sx0, t, x0, p, k, ip);
    }
    ...
    virtual void fx0_fixedParameters(realtype *x0, const realtype t,
                                     const realtype *p,
                                     const realtype *k) override {
        x0_fixedParameters_Liu2011(x0, t, p, k);
    }
...
"k1",};
    ...
    virtual std::vector<std::string> getStateNames() const override {
        return std::vector<std::string>{"CRP",
"PC",
"PC/CRP",
"C4",
"C4a",
