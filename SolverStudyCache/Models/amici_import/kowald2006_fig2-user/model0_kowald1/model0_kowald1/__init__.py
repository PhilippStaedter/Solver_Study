"""AMICI-generated module for model model0_kowald1"""

import amici

# Ensure we are binary-compatible, see #556
if '0.10.7' != amici.__version__:
    raise RuntimeError('Cannot use model model0_kowald1, generated with AMICI '
...
from model0_kowald1.model0_kowald1 import *
