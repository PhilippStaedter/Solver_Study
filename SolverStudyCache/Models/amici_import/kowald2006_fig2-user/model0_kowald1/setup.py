...
sources = ['swig/model0_kowald1.i', *getModelSources()]
...
# Build shared object
model_module = Extension('model0_kowald1._model0_kowald1',
                         sources=sources,
                         ...
                         swig_opts=['-c++', '-modern', '-outdir', 'model0_kowald1',
...
setup(
    name='model0_kowald1',
    version='0.1.0',
    description='AMICI-generated module for model model0_kowald1',
