...
sources = ['swig/model0_butenas1.i', *getModelSources()]
...
# Build shared object
model_module = Extension('model0_butenas1._model0_butenas1',
                         sources=sources,
                         ...
                         swig_opts=['-c++', '-modern', '-outdir', 'model0_butenas1',
...
# Install
setup(
    name='model0_butenas1',
    version='0.1.0',
    description='AMICI-generated module for model model0_butenas1',
