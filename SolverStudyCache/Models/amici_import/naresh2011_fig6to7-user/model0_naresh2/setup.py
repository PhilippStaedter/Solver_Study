...
sources = ['swig/model0_naresh2.i', *getModelSources()]
...
# Build shared object
model_module = Extension('model0_naresh2._model0_naresh2',
                         sources=sources,
                         ...
                         swig_opts=['-c++', '-modern', '-outdir', 'model0_naresh2',
...
setup(
    name='model0_naresh2',
    version='0.1.0',
    description='AMICI-generated module for model model0_naresh2',
