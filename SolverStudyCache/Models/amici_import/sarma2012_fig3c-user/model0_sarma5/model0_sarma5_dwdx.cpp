...
void dwdx_model0_sarma5(realtype *dwdx, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *tcl){
    dwdx[0] = 1.0*reaction_0_V1/(reaction_0_K1*(1 + species_0/reaction_0_K1)*(1 + species_7/reaction_0_KI)) - 1.0*reaction_0_V1*species_0/(pow(reaction_0_K1, 2)*pow(1 + species_0/reaction_0_K1, 2)*(1 + species_7/reaction_0_KI));
    dwdx[1] = 1.0*reaction_1_k3*species_2*(reaction_1_A*species_7/reaction_1_Ka + 1)/(reaction_1_K3*(1 + species_7/reaction_1_Ka)*(1 + species_2/reaction_1_K3 + species_3/reaction_1_K3));
    dwdx[2] = 1.0*reaction_2_k4*species_3*(reaction_2_A*species_7/reaction_2_Ka + 1)/(reaction_2_K4*(1 + species_7/reaction_2_Ka)*(1 + species_2/reaction_2_K4 + species_3/reaction_2_K4));
    ...
    dwdx[6] = 1.0*reaction_1_k3*species_1*(reaction_1_A*species_7/reaction_1_Ka + 1)/(reaction_1_K3*(1 + species_7/reaction_1_Ka)*(1 + species_2/reaction_1_K3 + species_3/reaction_1_K3)) - 1.0*reaction_1_k3*species_1*species_2*(reaction_1_A*species_7/reaction_1_Ka + 1)/(pow(reaction_1_K3, 2)*(1 + species_7/reaction_1_Ka)*pow(1 + species_2/reaction_1_K3 + species_3/reaction_1_K3, 2));
    dwdx[7] = -1.0*reaction_2_k4*species_1*species_3*(reaction_2_A*species_7/reaction_2_Ka + 1)/(pow(reaction_2_K4, 2)*(1 + species_7/reaction_2_Ka)*pow(1 + species_2/reaction_2_K4 + species_3/reaction_2_K4, 2));
    dwdx[8] = -1.0*reaction_1_k3*species_1*species_2*(reaction_1_A*species_7/reaction_1_Ka + 1)/(pow(reaction_1_K3, 2)*(1 + species_7/reaction_1_Ka)*pow(1 + species_2/reaction_1_K3 + species_3/reaction_1_K3, 2));
    dwdx[9] = 1.0*reaction_2_k4*species_1*(reaction_2_A*species_7/reaction_2_Ka + 1)/(reaction_2_K4*(1 + species_7/reaction_2_Ka)*(1 + species_2/reaction_2_K4 + species_3/reaction_2_K4)) - 1.0*reaction_2_k4*species_1*species_3*(reaction_2_A*species_7/reaction_2_Ka + 1)/(pow(reaction_2_K4, 2)*(1 + species_7/reaction_2_Ka)*pow(1 + species_2/reaction_2_K4 + species_3/reaction_2_K4, 2));
    ...
    dwdx[22] = -1.0*reaction_0_V1*species_0/(reaction_0_K1*reaction_0_KI*(1 + species_0/reaction_0_K1)*pow(1 + species_7/reaction_0_KI, 2));
    dwdx[23] = 1.0*reaction_1_A*reaction_1_k3*species_1*species_2/(reaction_1_K3*reaction_1_Ka*(1 + species_7/reaction_1_Ka)*(1 + species_2/reaction_1_K3 + species_3/reaction_1_K3)) - 1.0*reaction_1_k3*species_1*species_2*(reaction_1_A*species_7/reaction_1_Ka + 1)/(reaction_1_K3*reaction_1_Ka*pow(1 + species_7/reaction_1_Ka, 2)*(1 + species_2/reaction_1_K3 + species_3/reaction_1_K3));
    dwdx[24] = 1.0*reaction_2_A*reaction_2_k4*species_1*species_3/(reaction_2_K4*reaction_2_Ka*(1 + species_7/reaction_2_Ka)*(1 + species_2/reaction_2_K4 + species_3/reaction_2_K4)) - 1.0*reaction_2_k4*species_1*species_3*(reaction_2_A*species_7/reaction_2_Ka + 1)/(reaction_2_K4*reaction_2_Ka*pow(1 + species_7/reaction_2_Ka, 2)*(1 + species_2/reaction_2_K4 + species_3/reaction_2_K4));
