...
sources = ['swig/model0_BIOMD0000000037.i', *getModelSources()]
...
# Build shared object
model_module = Extension('model0_BIOMD0000000037._model0_BIOMD0000000037',
                         sources=sources,
                         ...
                         swig_opts=['-c++', '-modern', '-outdir', 'model0_BIOMD0000000037',
...
# Install
setup(
    name='model0_BIOMD0000000037',
    version='0.1.0',
    description='AMICI-generated module for model model0_BIOMD0000000037',
