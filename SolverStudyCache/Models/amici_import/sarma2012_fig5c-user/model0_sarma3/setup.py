...
sources = ['swig/model0_sarma3.i', *getModelSources()]
...
# Build shared object
model_module = Extension('model0_sarma3._model0_sarma3',
                         sources=sources,
                         ...
                         swig_opts=['-c++', '-modern', '-outdir', 'model0_sarma3',
...
setup(
    name='model0_sarma3',
    version='0.1.0',
    description='AMICI-generated module for model model0_sarma3',
