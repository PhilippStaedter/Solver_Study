...
sources = ['swig/leloup1_Fig2A.i', *getModelSources()]
...
# Build shared object
model_module = Extension('leloup1_Fig2A._leloup1_Fig2A',
                         sources=sources,
                         ...
                         swig_opts=['-c++', '-modern', '-outdir', 'leloup1_Fig2A',
...
setup(
    name='leloup1_Fig2A',
    version='0.1.0',
    description='AMICI-generated module for model leloup1_Fig2A',
