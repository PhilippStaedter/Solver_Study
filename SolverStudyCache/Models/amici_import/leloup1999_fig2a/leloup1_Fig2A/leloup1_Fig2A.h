 ...
 * @return
 */
extern void J_leloup1_Fig2A(realtype *J, const realtype t, const realtype *x,
                            const realtype *p, const realtype *k,
                            const realtype *h, const realtype *w,
                            const realtype *dwdx);
extern void JB_leloup1_Fig2A(realtype *JB, const realtype t, const realtype *x,
                             const realtype *p, const realtype *k,
                             const realtype *h, const realtype *xB,
                             const realtype *w, const realtype *dwdx);
extern void JDiag_leloup1_Fig2A(realtype *JDiag, const realtype t,
                                const realtype *x, const realtype *p,
                                const realtype *k, const realtype *h,
                                const realtype *w, const realtype *dwdx);
extern void JSparse_leloup1_Fig2A(realtype *JSparse, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *dwdx);
extern void JSparse_colptrs_leloup1_Fig2A(sunindextype *colptrs);
extern void JSparse_rowvals_leloup1_Fig2A(sunindextype *rowvals);
extern void JSparseB_leloup1_Fig2A(realtype *JSparseB, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *xB, const realtype *w, const realtype *dwdx);
extern void JSparseB_colptrs_leloup1_Fig2A(sunindextype *colptrs);
extern void JSparseB_rowvals_leloup1_Fig2A(sunindextype *rowvals);
extern void Jy_leloup1_Fig2A(realtype *nllh, const int iy, const realtype *p,
                             const realtype *k, const realtype *y,
                             const realtype *sigmay, const realtype *my);
extern void dJydsigmay_leloup1_Fig2A(realtype *dJydsigmay, const int iy,
                                     const realtype *p, const realtype *k,
                                     const realtype *y, const realtype *sigmay,
                                     const realtype *my);
extern void dJydy_leloup1_Fig2A(realtype *dJydy, const int iy, const realtype *p, const realtype *k, const realtype *y, const realtype *sigmay, const realtype *my);
extern void dJydy_colptrs_leloup1_Fig2A(sunindextype *colptrs, int index);
extern void dJydy_rowvals_leloup1_Fig2A(sunindextype *rowvals, int index);
extern void dwdp_leloup1_Fig2A(realtype *dwdp, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *tcl, const realtype *dtcldp, const int ip);
extern void dwdx_leloup1_Fig2A(realtype *dwdx, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *tcl);
extern void dwdx_colptrs_leloup1_Fig2A(sunindextype *colptrs);
extern void dwdx_rowvals_leloup1_Fig2A(sunindextype *rowvals);
extern void dxdotdw_leloup1_Fig2A(realtype *dxdotdw, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w);
extern void dxdotdw_colptrs_leloup1_Fig2A(sunindextype *colptrs);
extern void dxdotdw_rowvals_leloup1_Fig2A(sunindextype *rowvals);
extern void dxdotdp_leloup1_Fig2A(realtype *dxdotdp, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const int ip, const realtype *w);
extern void dydx_leloup1_Fig2A(realtype *dydx, const realtype t,
                               const realtype *x, const realtype *p,
                               const realtype *k, const realtype *h,
                               const realtype *w, const realtype *dwdx);
extern void dydp_leloup1_Fig2A(realtype *dydp, const realtype t,
                               const realtype *x, const realtype *p,
                               const realtype *k, const realtype *h,
                               const int ip, const realtype *w,
                               const realtype *dwp);
extern void dsigmaydp_leloup1_Fig2A(realtype *dsigmaydp, const realtype t,
                                    const realtype *p, const realtype *k,
                                    const int ip);
extern void sigmay_leloup1_Fig2A(realtype *sigmay, const realtype t,
                                 const realtype *p, const realtype *k);
extern void w_leloup1_Fig2A(realtype *w, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *tcl);
extern void x0_leloup1_Fig2A(realtype *x0, const realtype t, const realtype *p,
                             const realtype *k);
extern void x0_fixedParameters_leloup1_Fig2A(realtype *x0, const realtype t,
                                             const realtype *p,
                                             const realtype *k);
extern void sx0_leloup1_Fig2A(realtype *sx0, const realtype t,
                              const realtype *x0, const realtype *p,
                              const realtype *k, const int ip);
extern void sx0_fixedParameters_leloup1_Fig2A(realtype *sx0, const realtype t,
                                              const realtype *x0,
                                              const realtype *p,
                                              const realtype *k, const int ip);
extern void xdot_leloup1_Fig2A(realtype *xdot, const realtype t,
                               const realtype *x, const realtype *p,
                               const realtype *k, const realtype *h,
                               const realtype *w);
extern void y_leloup1_Fig2A(realtype *y, const realtype t, const realtype *x,
                            const realtype *p, const realtype *k,
                            const realtype *h, const realtype *w);

extern void x_solver_leloup1_Fig2A(realtype *x_solver, const realtype *x_rdata);
extern void total_cl_leloup1_Fig2A(realtype *total_cl, const realtype *x_rdata);

/**
 * @brief AMICI-generated model subclass.
 */
class Model_leloup1_Fig2A : public amici::Model_ODE {
  public:
    /**
    ...
    Model_leloup1_Fig2A()
        : amici::Model_ODE(
              ...
              std::vector<realtype>{2.0, 0.7, 0.2, 0.7, 0.01, 4.0, 1.0, 1.0, 0.2, 0.01, 4.0, 1.0, 1.0, 0.01, 0.9, 8.0, 2.0, 0.01, 1.0, 2.0, 8.0, 2.0, 0.2, 2.0, 0.01, 1.0, 2.0, 0.01, 0.6, 1.2, 0.2, 0.6, 0.01, 0.01, 0.9, 8.0, 2.0, 0.01, 1.0, 2.0, 8.0, 2.0, 0.2, 0.01, 1.0, 2.0},       // dynamic parameters
              std::vector<realtype>{}, // fixedParameters
              std::vector<int>{},                          // plist
              std::vector<realtype>(10, 0.0),   // idlist
    ...
    virtual amici::Model *clone() const override {
        return new Model_leloup1_Fig2A(*this);
    }
    ...
    virtual void fJ(realtype *J, const realtype t, const realtype *x,
        ...
        J_leloup1_Fig2A(J, t, x, p, k, h, w, dwdx);
    }
    ...
    virtual void fJB(realtype *JB, const realtype t, const realtype *x,
        ...
        JB_leloup1_Fig2A(JB, t, x, p, k, h, xB, w, dwdx);
    }
    ...
    virtual void fJDiag(realtype *JDiag, const realtype t, const realtype *x,
                        const realtype *p, const realtype *k, const realtype *h,
                        const realtype *w, const realtype *dwdx) override {
        JDiag_leloup1_Fig2A(JDiag, t, x, p, k, h, w, dwdx);
    }
    ...
    virtual void fJSparse(realtype *JSparse, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *dwdx) override {
        JSparse_leloup1_Fig2A( JSparse,  t,  x,  p,  k,  h,  w,  dwdx);
    }


    virtual void fJSparse_colptrs(sunindextype *colptrs) override {
        JSparse_colptrs_leloup1_Fig2A(colptrs);
    }


    virtual void fJSparse_rowvals(sunindextype *rowvals) override {
        JSparse_rowvals_leloup1_Fig2A(rowvals);
    }
    ...
    virtual void fJSparseB(realtype *JSparseB, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *xB, const realtype *w, const realtype *dwdx) override {
        JSparseB_leloup1_Fig2A( JSparseB,  t,  x,  p,  k,  h,  xB,  w,  dwdx);
    }


    virtual void fJSparseB_colptrs(sunindextype *colptrs) override {
        JSparseB_colptrs_leloup1_Fig2A(colptrs);
    }


    virtual void fJSparseB_rowvals(sunindextype *rowvals) override {
        JSparseB_rowvals_leloup1_Fig2A(rowvals);
    }
    ...
    virtual void fJy(realtype *nllh, const int iy, const realtype *p,
        ...
        Jy_leloup1_Fig2A(nllh, iy, p, k, y, sigmay, my);
    }
    ...
    virtual void fdJydsigma(realtype *dJydsigma, const int iy,
        ...
        dJydsigmay_leloup1_Fig2A(dJydsigma, iy, p, k, y, sigmay, my);
    }
    ...
    virtual void fdsigmaydp(realtype *dsigmaydp, const realtype t,
        ...
        dsigmaydp_leloup1_Fig2A(dsigmaydp, t, p, k, ip);
    }
    ...
    virtual void fdwdp(realtype *dwdp, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *tcl, const realtype *dtcldp, const int ip) override {
        dwdp_leloup1_Fig2A( dwdp,  t,  x,  p,  k,  h,  w,  tcl,  dtcldp,  ip);
    }
    ...
    virtual void fdwdx(realtype *dwdx, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *tcl) override {
        dwdx_leloup1_Fig2A( dwdx,  t,  x,  p,  k,  h,  w,  tcl);
    }
    ...
    virtual void fdxdotdp(realtype *dxdotdp, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const int ip, const realtype *w) override {
        dxdotdp_leloup1_Fig2A( dxdotdp,  t,  x,  p,  k,  h,  ip,  w);
    }
    ...
    virtual void fdydx(realtype *dydx, const realtype t, const realtype *x,
                       const realtype *p, const realtype *k, const realtype *h,
                       const realtype *w, const realtype *dwdx) override {
        dydx_leloup1_Fig2A(dydx, t, x, p, k, h, w, dwdx);
    }
    ...
    virtual void fdydp(realtype *dydp, const realtype t, const realtype *x,
        ...
        dydp_leloup1_Fig2A(dydp, t, x, p, k, h, ip, w, dwdp);
    }
    ...
    virtual void fsigmay(realtype *sigmay, const realtype t, const realtype *p,
        ...
        sigmay_leloup1_Fig2A(sigmay, t, p, k);
    }
    ...
    virtual void fsx0(realtype *sx0, const realtype t, const realtype *x0,
                      const realtype *p, const realtype *k,
                      const int ip) override {
        sx0_leloup1_Fig2A(sx0, t, x0, p, k, ip);
    }
    ...
    virtual void fsx0_fixedParameters(realtype *sx0, const realtype t,
                                      ...
                                      const realtype *k,
                                      const int ip) override {
        sx0_fixedParameters_leloup1_Fig2A(sx0, t, x0, p, k, ip);
    }
    ...
    virtual void fw(realtype *w, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *tcl) override {
        w_leloup1_Fig2A( w,  t,  x,  p,  k,  h,  tcl);
    }
    ...
    virtual void fx0_fixedParameters(realtype *x0, const realtype t,
                                     const realtype *p,
                                     const realtype *k) override {
        x0_fixedParameters_leloup1_Fig2A(x0, t, p, k);
    }
    ...
    virtual void fxdot(realtype *xdot, const realtype t, const realtype *x,
        ...
        xdot_leloup1_Fig2A(xdot, t, x, p, k, h, w);
    }
    ...
    virtual void fx_solver(realtype *x_solver, const realtype *x_rdata) override {
        x_solver_leloup1_Fig2A( x_solver,  x_rdata);
    }


    virtual void ftotal_cl(realtype *total_cl, const realtype *x_rdata) override {
        total_cl_leloup1_Fig2A( total_cl,  x_rdata);
    }
...
"",};
    ...
    virtual std::vector<std::string> getStateNames() const override {
        return std::vector<std::string>{"Cytosolic PER-TIM Complex",
...
"x9",};
    ...
    virtual std::vector<std::string> getParameterIds() const override {
        return std::vector<std::string>{"V_dT",
"V_mT",
"Mp_degradation_K_mP",
"Mp_degradation_V_mP",
"Mp_degradation_k_d",
...
"P2_to_P1_V_4P",
"P2_to_P1_K_4P",
"PT_complex_degradation_k_dC",
"PT_complex_formation_k4",
"PT_complex_formation_k3",
"PT_complex_nucleation_k2",
"PT_complex_nucleation_k1",
"PTnucl_complex_degradation_k_dN",
"T0_degradation_k_d",
"T0_production_k_sT",
"T0_to_T1_V_1T",
"T0_to_T1_K_1T",
...
"T2_to_T1_K_4T",};
    ...
    virtual std::vector<std::string> getStateIds() const override {
        return std::vector<std::string>{"CC",
"Cn",
"Mp",
"Mt",
"P0",
