...
sources = ['swig/model2_bungay3.i', *getModelSources()]
...
# Build shared object
model_module = Extension('model2_bungay3._model2_bungay3',
                         sources=sources,
                         ...
                         swig_opts=['-c++', '-modern', '-outdir', 'model2_bungay3',
...
setup(
    name='model2_bungay3',
    version='0.1.0',
    description='AMICI-generated module for model model2_bungay3',
