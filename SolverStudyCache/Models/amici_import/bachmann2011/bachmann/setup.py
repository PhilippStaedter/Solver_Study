...
sources = ['swig/bachmann.i', *getModelSources()]
...
# Build shared object
model_module = Extension('bachmann._bachmann',
                         sources=sources,
                         ...
                         swig_opts=['-c++', '-modern', '-outdir', 'bachmann',
...
setup(
    name='bachmann',
    version='0.1.0',
    description='AMICI-generated module for model bachmann',
