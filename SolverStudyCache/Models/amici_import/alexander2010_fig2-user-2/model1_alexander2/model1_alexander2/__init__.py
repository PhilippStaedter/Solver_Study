"""AMICI-generated module for model model1_alexander2"""

import amici

# Ensure we are binary-compatible, see #556
if '0.10.7' != amici.__version__:
    raise RuntimeError('Cannot use model model1_alexander2, generated with AMICI '
...
from model1_alexander2.model1_alexander2 import *
