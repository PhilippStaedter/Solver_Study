...
/*-----------------------------------------------
              @(target):= _model0_bindschadler1.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__model0_bindschadler1

#else
#  define SWIG_init    init_model0_bindschadler1

#endif
#define SWIG_name    "_model0_bindschadler1"
