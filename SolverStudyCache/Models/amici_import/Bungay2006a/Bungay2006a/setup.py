...
sources = ['swig/Bungay2006a.i', *getModelSources()]
...
# Build shared object
model_module = Extension('Bungay2006a._Bungay2006a',
                         sources=sources,
                         ...
                         swig_opts=['-c++', '-modern', '-outdir', 'Bungay2006a',
...
setup(
    name='Bungay2006a',
    version='0.1.0',
    description='AMICI-generated module for model Bungay2006a',
