...
void x_rdata_model3_levering2(realtype *x_rdata, const realtype *x, const realtype *tcl){
    x_rdata[0] = species_1;
    ...
    x_rdata[18] = species_3;
    x_rdata[19] = species_4;
    x_rdata[20] = species_5;
    x_rdata[21] = species_6;
    x_rdata[22] = species_7;
    x_rdata[23] = species_8;
    x_rdata[24] = species_9;
}