...
sources = ['swig/model3_levering2.i', *getModelSources()]
...
# Build shared object
model_module = Extension('model3_levering2._model3_levering2',
                         sources=sources,
                         ...
                         swig_opts=['-c++', '-modern', '-outdir', 'model3_levering2',
...
# Install
setup(
    name='model3_levering2',
    version='0.1.0',
    description='AMICI-generated module for model model3_levering2',
