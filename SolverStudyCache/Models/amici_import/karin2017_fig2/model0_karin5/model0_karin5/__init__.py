"""AMICI-generated module for model model0_karin5"""

import amici

# Ensure we are binary-compatible, see #556
if '0.10.7' != amici.__version__:
    raise RuntimeError('Cannot use model model0_karin5, generated with AMICI '
...
from model0_karin5.model0_karin5 import *
