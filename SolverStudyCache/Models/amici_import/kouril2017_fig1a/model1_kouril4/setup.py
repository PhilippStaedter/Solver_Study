...
sources = ['swig/model1_kouril4.i', *getModelSources()]
...
# Build shared object
model_module = Extension('model1_kouril4._model1_kouril4',
                         sources=sources,
                         ...
                         swig_opts=['-c++', '-modern', '-outdir', 'model1_kouril4',
...
setup(
    name='model1_kouril4',
    version='0.1.0',
    description='AMICI-generated module for model model1_kouril4',
