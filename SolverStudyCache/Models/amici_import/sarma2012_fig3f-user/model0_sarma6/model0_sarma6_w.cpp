...
void w_model0_sarma6(realtype *w, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *tcl){
    ...
    w[2] = 1.0*reaction_2_k4*species_1*species_3/(reaction_2_K4*(1 + species_7/reaction_2_KI)*(1 + species_2/reaction_2_K4 + species_3/reaction_2_K4));
