...
void dwdp_model0_sarma6(realtype *dwdp, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *tcl, const realtype *dtcldp, const int ip){
    switch(ip) {
        case 0:
        ...
        case 7:
            ...
            break;
        case 8:
            dwdp[2] = 1.0*reaction_2_k4*species_1*species_3*species_7/(reaction_2_K4*pow(reaction_2_KI, 2)*pow(1 + species_7/reaction_2_KI, 2)*(1 + species_2/reaction_2_K4 + species_3/reaction_2_K4));
            break;
        case 9:
            dwdp[2] = 1.0*species_1*species_3/(reaction_2_K4*(1 + species_7/reaction_2_KI)*(1 + species_2/reaction_2_K4 + species_3/reaction_2_K4));
            break;
        case 10:
