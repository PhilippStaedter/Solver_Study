...
sources = ['swig/model0_liu2.i', *getModelSources()]
...
# Build shared object
model_module = Extension('model0_liu2._model0_liu2',
                         sources=sources,
                         ...
                         swig_opts=['-c++', '-modern', '-outdir', 'model0_liu2',
...
setup(
    name='model0_liu2',
    version='0.1.0',
    description='AMICI-generated module for model model0_liu2',
