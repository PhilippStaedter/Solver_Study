...
sources = ['swig/model1_liu2.i', *getModelSources()]
...
# Build shared object
model_module = Extension('model1_liu2._model1_liu2',
                         sources=sources,
                         ...
                         swig_opts=['-c++', '-modern', '-outdir', 'model1_liu2',
...
setup(
    name='model1_liu2',
    version='0.1.0',
    description='AMICI-generated module for model model1_liu2',
