...
sources = ['swig/model2_sarma7.i', *getModelSources()]
...
# Build shared object
model_module = Extension('model2_sarma7._model2_sarma7',
                         sources=sources,
                         ...
                         swig_opts=['-c++', '-modern', '-outdir', 'model2_sarma7',
...
setup(
    name='model2_sarma7',
    version='0.1.0',
    description='AMICI-generated module for model model2_sarma7',
