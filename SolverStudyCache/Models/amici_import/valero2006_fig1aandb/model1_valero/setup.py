...
sources = ['swig/model1_valero.i', *getModelSources()]
...
# Build shared object
model_module = Extension('model1_valero._model1_valero',
                         sources=sources,
                         ...
                         swig_opts=['-c++', '-modern', '-outdir', 'model1_valero',
...
setup(
    name='model1_valero',
    version='0.1.0',
    description='AMICI-generated module for model model1_valero',
