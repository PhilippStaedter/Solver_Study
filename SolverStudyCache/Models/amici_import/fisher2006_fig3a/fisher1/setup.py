...
sources = ['swig/fisher1.i', *getModelSources()]
...
# Build shared object
model_module = Extension('fisher1._fisher1',
                         sources=sources,
                         ...
                         swig_opts=['-c++', '-modern', '-outdir', 'fisher1',
...
setup(
    name='fisher1',
    version='0.1.0',
    description='AMICI-generated module for model fisher1',
