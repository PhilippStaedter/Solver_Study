 ...
 * @return
 */
extern void J_fisher1(realtype *J, const realtype t, const realtype *x,
                            const realtype *p, const realtype *k,
                            const realtype *h, const realtype *w,
                            const realtype *dwdx);
extern void JB_fisher1(realtype *JB, const realtype t, const realtype *x,
                             const realtype *p, const realtype *k,
                             const realtype *h, const realtype *xB,
                             const realtype *w, const realtype *dwdx);
extern void JDiag_fisher1(realtype *JDiag, const realtype t,
                                const realtype *x, const realtype *p,
                                const realtype *k, const realtype *h,
                                const realtype *w, const realtype *dwdx);
extern void JSparse_fisher1(realtype *JSparse, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *dwdx);
extern void JSparse_colptrs_fisher1(sunindextype *colptrs);
extern void JSparse_rowvals_fisher1(sunindextype *rowvals);
extern void JSparseB_fisher1(realtype *JSparseB, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *xB, const realtype *w, const realtype *dwdx);
extern void JSparseB_colptrs_fisher1(sunindextype *colptrs);
extern void JSparseB_rowvals_fisher1(sunindextype *rowvals);
extern void Jy_fisher1(realtype *nllh, const int iy, const realtype *p,
                             const realtype *k, const realtype *y,
                             const realtype *sigmay, const realtype *my);
extern void dJydsigmay_fisher1(realtype *dJydsigmay, const int iy,
                                     const realtype *p, const realtype *k,
                                     const realtype *y, const realtype *sigmay,
                                     const realtype *my);
extern void dJydy_fisher1(realtype *dJydy, const int iy, const realtype *p, const realtype *k, const realtype *y, const realtype *sigmay, const realtype *my);
extern void dJydy_colptrs_fisher1(sunindextype *colptrs, int index);
extern void dJydy_rowvals_fisher1(sunindextype *rowvals, int index);
extern void dwdp_fisher1(realtype *dwdp, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *tcl, const realtype *dtcldp, const int ip);
extern void dwdx_fisher1(realtype *dwdx, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *tcl);
extern void dwdx_colptrs_fisher1(sunindextype *colptrs);
extern void dwdx_rowvals_fisher1(sunindextype *rowvals);
extern void dxdotdw_fisher1(realtype *dxdotdw, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w);
extern void dxdotdw_colptrs_fisher1(sunindextype *colptrs);
extern void dxdotdw_rowvals_fisher1(sunindextype *rowvals);
extern void dxdotdp_fisher1(realtype *dxdotdp, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const int ip, const realtype *w);
extern void dydx_fisher1(realtype *dydx, const realtype t,
                               const realtype *x, const realtype *p,
                               const realtype *k, const realtype *h,
                               const realtype *w, const realtype *dwdx);
extern void dydp_fisher1(realtype *dydp, const realtype t,
                               const realtype *x, const realtype *p,
                               const realtype *k, const realtype *h,
                               const int ip, const realtype *w,
                               const realtype *dwp);
extern void dsigmaydp_fisher1(realtype *dsigmaydp, const realtype t,
                                    const realtype *p, const realtype *k,
                                    const int ip);
extern void sigmay_fisher1(realtype *sigmay, const realtype t,
                                 const realtype *p, const realtype *k);
extern void w_fisher1(realtype *w, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *tcl);
extern void x0_fisher1(realtype *x0, const realtype t, const realtype *p,
                             const realtype *k);
extern void x0_fixedParameters_fisher1(realtype *x0, const realtype t,
                                             const realtype *p,
                                             const realtype *k);
extern void sx0_fisher1(realtype *sx0, const realtype t,
                              const realtype *x0, const realtype *p,
                              const realtype *k, const int ip);
extern void sx0_fixedParameters_fisher1(realtype *sx0, const realtype t,
                                              const realtype *x0,
                                              const realtype *p,
                                              const realtype *k, const int ip);
extern void xdot_fisher1(realtype *xdot, const realtype t,
                               const realtype *x, const realtype *p,
                               const realtype *k, const realtype *h,
                               const realtype *w);
extern void y_fisher1(realtype *y, const realtype t, const realtype *x,
                            const realtype *p, const realtype *k,
                            const realtype *h, const realtype *w);

extern void x_solver_fisher1(realtype *x_solver, const realtype *x_rdata);
extern void total_cl_fisher1(realtype *total_cl, const realtype *x_rdata);

/**
 * @brief AMICI-generated model subclass.
 */
class Model_fisher1 : public amici::Model_ODE {
  public:
    /**
    ...
    Model_fisher1()
        : amici::Model_ODE(
              ...
              std::vector<realtype>{2.56e-05, 0.005, 6.63, 0.00168, 0.5, 0.00256, 0.00168, 6.63, 0.0015, 0.00096, 1.0, 0.00256, 1.0, 0.21, 0.5, 0.005, 0.5, 0.0019, 0.00092, 0.005, 0.5, 0.5},       // dynamic parameters
    ...
    virtual void fJB(realtype *JB, const realtype t, const realtype *x,
        ...
        JB_fisher1(JB, t, x, p, k, h, xB, w, dwdx);
    }
    ...
    virtual void fJDiag(realtype *JDiag, const realtype t, const realtype *x,
                        const realtype *p, const realtype *k, const realtype *h,
                        const realtype *w, const realtype *dwdx) override {
        JDiag_fisher1(JDiag, t, x, p, k, h, w, dwdx);
    }
    ...
    virtual void fJy(realtype *nllh, const int iy, const realtype *p,
        ...
        Jy_fisher1(nllh, iy, p, k, y, sigmay, my);
    }
    ...
    virtual void fdJydsigma(realtype *dJydsigma, const int iy,
        ...
        dJydsigmay_fisher1(dJydsigma, iy, p, k, y, sigmay, my);
    }
    ...
    virtual void fdsigmaydp(realtype *dsigmaydp, const realtype t,
        ...
        dsigmaydp_fisher1(dsigmaydp, t, p, k, ip);
    }
    ...
    virtual void fdwdp(realtype *dwdp, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *tcl, const realtype *dtcldp, const int ip) override {
        dwdp_fisher1( dwdp,  t,  x,  p,  k,  h,  w,  tcl,  dtcldp,  ip);
    }
    ...
    virtual void fdwdx(realtype *dwdx, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *tcl) override {
        dwdx_fisher1( dwdx,  t,  x,  p,  k,  h,  w,  tcl);
    }
    ...
    virtual void fdxdotdp(realtype *dxdotdp, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const int ip, const realtype *w) override {
        dxdotdp_fisher1( dxdotdp,  t,  x,  p,  k,  h,  ip,  w);
    }
    ...
    virtual void fdydx(realtype *dydx, const realtype t, const realtype *x,
                       const realtype *p, const realtype *k, const realtype *h,
                       const realtype *w, const realtype *dwdx) override {
        dydx_fisher1(dydx, t, x, p, k, h, w, dwdx);
    }
    ...
    virtual void fdydp(realtype *dydp, const realtype t, const realtype *x,
        ...
        dydp_fisher1(dydp, t, x, p, k, h, ip, w, dwdp);
    }
    ...
    virtual void fsx0_fixedParameters(realtype *sx0, const realtype t,
                                      ...
                                      const realtype *k,
                                      const int ip) override {
        sx0_fixedParameters_fisher1(sx0, t, x0, p, k, ip);
    }
    ...
    virtual void fx0_fixedParameters(realtype *x0, const realtype t,
                                     const realtype *p,
                                     const realtype *k) override {
        x0_fixedParameters_fisher1(x0, t, p, k);
    }
...
"",};
    ...
    virtual std::vector<std::string> getStateNames() const override {
        return std::vector<std::string>{"Active Calcineurin in cytosol",
"Active Calcineurin in nucleus",
"Calcium in Cytosol",
"Calcium in Nucleus",
"Inactive Calcineurin in cytosol",
"Inactive Calcineurin in nucleus",
"NFAT Calcineurin complex in cytosol",
"NFAT Calcineurin complex in nucleus",
"NFAT_Cyt",
"NFAT_Nuc",
"Phosphorylated NFAT Calcineurin complex in cytosol",
"Phosphorylated NFAT Calcineurin complex in nucleus",
"Phosphorylated NFAT in cytosol",
...
"k9",};
    ...
    virtual std::vector<std::string> getStateIds() const override {
        return std::vector<std::string>{"Act_C_Cyt",
"Act_C_Nuc",
"Ca_Cyt",
"Ca_Nuc",
"Inact_C_Cyt",
