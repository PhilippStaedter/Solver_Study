...
void JSparse_model0_mcauley1(realtype *JSparse, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *dwdx){
    JSparse[0] = 1.0*dwdx0;
    JSparse[1] = -1.0*dwdx1;
    JSparse[2] = -1.0*dwdx1;
    JSparse[3] = 1.0*dwdx1;
