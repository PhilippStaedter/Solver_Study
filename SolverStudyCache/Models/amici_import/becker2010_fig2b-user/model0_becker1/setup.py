...
sources = ['swig/model0_becker1.i', *getModelSources()]
...
# Build shared object
model_module = Extension('model0_becker1._model0_becker1',
                         sources=sources,
                         ...
                         swig_opts=['-c++', '-modern', '-outdir', 'model0_becker1',
...
setup(
    name='model0_becker1',
    version='0.1.0',
    description='AMICI-generated module for model model0_becker1',
