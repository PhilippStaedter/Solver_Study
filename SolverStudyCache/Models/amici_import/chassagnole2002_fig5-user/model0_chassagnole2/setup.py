...
sources = ['swig/model0_chassagnole2.i', *getModelSources()]
...
# Build shared object
model_module = Extension('model0_chassagnole2._model0_chassagnole2',
                         sources=sources,
                         ...
                         swig_opts=['-c++', '-modern', '-outdir', 'model0_chassagnole2',
...
# Install
setup(
    name='model0_chassagnole2',
    version='0.1.0',
    description='AMICI-generated module for model model0_chassagnole2',
