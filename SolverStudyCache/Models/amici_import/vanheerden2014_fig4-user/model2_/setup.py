...
sources = ['swig/model2_.i', *getModelSources()]
...
# Build shared object
model_module = Extension('model2_._model2_',
                         sources=sources,
                         ...
                         swig_opts=['-c++', '-modern', '-outdir', 'model2_',
...
setup(
    name='model2_',
    version='0.1.0',
    description='AMICI-generated module for model model2_',
