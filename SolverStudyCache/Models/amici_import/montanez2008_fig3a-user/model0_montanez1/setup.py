...
sources = ['swig/model0_montanez1.i', *getModelSources()]
...
# Build shared object
model_module = Extension('model0_montanez1._model0_montanez1',
                         sources=sources,
                         ...
                         swig_opts=['-c++', '-modern', '-outdir', 'model0_montanez1',
...
# Install
setup(
    name='model0_montanez1',
    version='0.1.0',
    description='AMICI-generated module for model model0_montanez1',
