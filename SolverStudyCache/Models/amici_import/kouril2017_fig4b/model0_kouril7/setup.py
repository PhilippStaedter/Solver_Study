...
sources = ['swig/model0_kouril7.i', *getModelSources()]
...
# Build shared object
model_module = Extension('model0_kouril7._model0_kouril7',
                         sources=sources,
                         ...
                         swig_opts=['-c++', '-modern', '-outdir', 'model0_kouril7',
...
setup(
    name='model0_kouril7',
    version='0.1.0',
    description='AMICI-generated module for model model0_kouril7',
