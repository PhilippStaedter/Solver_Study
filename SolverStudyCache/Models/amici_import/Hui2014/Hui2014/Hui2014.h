 ...
 * @return
 */
extern void J_Hui2014(realtype *J, const realtype t, const realtype *x,
                            const realtype *p, const realtype *k,
                            const realtype *h, const realtype *w,
                            const realtype *dwdx);
extern void JB_Hui2014(realtype *JB, const realtype t, const realtype *x,
                             const realtype *p, const realtype *k,
                             const realtype *h, const realtype *xB,
                             const realtype *w, const realtype *dwdx);
extern void JDiag_Hui2014(realtype *JDiag, const realtype t,
                                const realtype *x, const realtype *p,
                                const realtype *k, const realtype *h,
                                const realtype *w, const realtype *dwdx);
extern void JSparse_Hui2014(realtype *JSparse, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *dwdx);
extern void JSparse_colptrs_Hui2014(sunindextype *colptrs);
extern void JSparse_rowvals_Hui2014(sunindextype *rowvals);
extern void JSparseB_Hui2014(realtype *JSparseB, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *xB, const realtype *w, const realtype *dwdx);
extern void JSparseB_colptrs_Hui2014(sunindextype *colptrs);
extern void JSparseB_rowvals_Hui2014(sunindextype *rowvals);
extern void Jy_Hui2014(realtype *nllh, const int iy, const realtype *p,
                             const realtype *k, const realtype *y,
                             const realtype *sigmay, const realtype *my);
extern void dJydsigmay_Hui2014(realtype *dJydsigmay, const int iy,
                                     const realtype *p, const realtype *k,
                                     const realtype *y, const realtype *sigmay,
                                     const realtype *my);
extern void dJydy_Hui2014(realtype *dJydy, const int iy, const realtype *p, const realtype *k, const realtype *y, const realtype *sigmay, const realtype *my);
extern void dJydy_colptrs_Hui2014(sunindextype *colptrs, int index);
extern void dJydy_rowvals_Hui2014(sunindextype *rowvals, int index);
extern void dwdp_Hui2014(realtype *dwdp, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *tcl, const realtype *dtcldp, const int ip);
extern void dwdx_Hui2014(realtype *dwdx, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *tcl);
extern void dwdx_colptrs_Hui2014(sunindextype *colptrs);
extern void dwdx_rowvals_Hui2014(sunindextype *rowvals);
extern void dxdotdw_Hui2014(realtype *dxdotdw, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w);
extern void dxdotdw_colptrs_Hui2014(sunindextype *colptrs);
extern void dxdotdw_rowvals_Hui2014(sunindextype *rowvals);
extern void dxdotdp_Hui2014(realtype *dxdotdp, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const int ip, const realtype *w);
extern void dydx_Hui2014(realtype *dydx, const realtype t,
                               const realtype *x, const realtype *p,
                               const realtype *k, const realtype *h,
                               const realtype *w, const realtype *dwdx);
extern void dydp_Hui2014(realtype *dydp, const realtype t,
                               const realtype *x, const realtype *p,
                               const realtype *k, const realtype *h,
                               const int ip, const realtype *w,
                               const realtype *dwp);
extern void dsigmaydp_Hui2014(realtype *dsigmaydp, const realtype t,
                                    const realtype *p, const realtype *k,
                                    const int ip);
extern void sigmay_Hui2014(realtype *sigmay, const realtype t,
                                 const realtype *p, const realtype *k);
extern void w_Hui2014(realtype *w, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *tcl);
extern void x0_Hui2014(realtype *x0, const realtype t, const realtype *p,
                             const realtype *k);
extern void x0_fixedParameters_Hui2014(realtype *x0, const realtype t,
                                             const realtype *p,
                                             const realtype *k);
extern void sx0_Hui2014(realtype *sx0, const realtype t,
                              const realtype *x0, const realtype *p,
                              const realtype *k, const int ip);
extern void sx0_fixedParameters_Hui2014(realtype *sx0, const realtype t,
                                              const realtype *x0,
                                              const realtype *p,
                                              const realtype *k, const int ip);
extern void xdot_Hui2014(realtype *xdot, const realtype t,
                               const realtype *x, const realtype *p,
                               const realtype *k, const realtype *h,
                               const realtype *w);
extern void y_Hui2014(realtype *y, const realtype t, const realtype *x,
                            const realtype *p, const realtype *k,
                            const realtype *h, const realtype *w);

extern void x_solver_Hui2014(realtype *x_solver, const realtype *x_rdata);
extern void total_cl_Hui2014(realtype *total_cl, const realtype *x_rdata);

/**
 * @brief AMICI-generated model subclass.
 */
class Model_Hui2014 : public amici::Model_ODE {
  public:
    /**
    ...
    Model_Hui2014()
        : amici::Model_ODE(
              ...
              std::vector<realtype>{1e-07, 8.3e-07, 8e-07, 4e-07, 1e-08, 0.0001, 1e-07, 0.0001, 0.001, 0.001, 5e-06, 0.001, 1e-07, 0.0001, 5e-05, 1.67, 0.000167, 7.5e-05, 1.67e-05, 5e-05, 0.0001, 0.5, 2e-05, 2e-05, 3e-05, 5e-06, 8e-06, 0.001, 9e-06, 5e-05, 1e-09, 1.2e-08, 4e-07, 0.000167, 0.00167, 0.00167, 1.07e-05, 1e-08, 4e-05, 1e-06, 0.005, 6.4e-06, 6.4e-06, 0.005, 5e-06, 1e-05, 0.001, 4.8e-05, 0.0001, 0.00578, 0.01, 0.01, 0.0005, 0.0006, 0.006, 0.0002, 0.0005, 0.0001, 0.0001, 0.0004, 5e-10, 1e-08, 0.0003, 0.0003, 0.0005, 0.1, 0.001, 0.0005, 0.0015, 0.05, 7e-06, 0.001, 1e-07, 0.0001, 2e-05, 4e-05, 1e-06, 0.01, 0.00167, 0.00167, 0.0005, 0.0167, 0.0167, 0.0167, 0.001, 1e-06, 1e-06, 1e-06, 0.000383, 0.0001, 0.0, 4.6e-06, 0.0005, 1e-06, 5e-06, 5e-06, 0.002, 1e-07, 0.0, 1e-06, 1e-06, 0.001, 0.005, 3.2e-05, 1.5e-06, 5e-06, 0.0, 0.0001, 1e-05, 0.002, 0.00048, 1e-05, 5e-06},       // dynamic parameters
              std::vector<realtype>{}, // fixedParameters
              std::vector<int>{},                          // plist
              std::vector<realtype>(65, 0.0),   // idlist
    ...
    virtual void fJB(realtype *JB, const realtype t, const realtype *x,
        ...
        JB_Hui2014(JB, t, x, p, k, h, xB, w, dwdx);
    }
    ...
    virtual void fJDiag(realtype *JDiag, const realtype t, const realtype *x,
                        const realtype *p, const realtype *k, const realtype *h,
                        const realtype *w, const realtype *dwdx) override {
        JDiag_Hui2014(JDiag, t, x, p, k, h, w, dwdx);
    }
    ...
    virtual void fJy(realtype *nllh, const int iy, const realtype *p,
        ...
        Jy_Hui2014(nllh, iy, p, k, y, sigmay, my);
    }
    ...
    virtual void fdJydsigma(realtype *dJydsigma, const int iy,
        ...
        dJydsigmay_Hui2014(dJydsigma, iy, p, k, y, sigmay, my);
    }
    ...
    virtual void fdsigmaydp(realtype *dsigmaydp, const realtype t,
        ...
        dsigmaydp_Hui2014(dsigmaydp, t, p, k, ip);
    }
    ...
    virtual void fdwdp(realtype *dwdp, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *tcl, const realtype *dtcldp, const int ip) override {
        dwdp_Hui2014( dwdp,  t,  x,  p,  k,  h,  w,  tcl,  dtcldp,  ip);
    }
    ...
    virtual void fdwdx(realtype *dwdx, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *tcl) override {
        dwdx_Hui2014( dwdx,  t,  x,  p,  k,  h,  w,  tcl);
    }
    ...
    virtual void fdxdotdp(realtype *dxdotdp, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const int ip, const realtype *w) override {
        dxdotdp_Hui2014( dxdotdp,  t,  x,  p,  k,  h,  ip,  w);
    }
    ...
    virtual void fdydx(realtype *dydx, const realtype t, const realtype *x,
                       const realtype *p, const realtype *k, const realtype *h,
                       const realtype *w, const realtype *dwdx) override {
        dydx_Hui2014(dydx, t, x, p, k, h, w, dwdx);
    }
    ...
    virtual void fdydp(realtype *dydp, const realtype t, const realtype *x,
        ...
        dydp_Hui2014(dydp, t, x, p, k, h, ip, w, dwdp);
    }
    ...
    virtual void fsx0_fixedParameters(realtype *sx0, const realtype t,
                                      ...
                                      const realtype *k,
                                      const int ip) override {
        sx0_fixedParameters_Hui2014(sx0, t, x0, p, k, ip);
    }
    ...
    virtual void fx0_fixedParameters(realtype *x0, const realtype t,
                                     const realtype *p,
                                     const realtype *k) override {
        x0_fixedParameters_Hui2014(x0, t, p, k);
    }
...
"x64",};
    ...
    virtual std::vector<std::string> getParameterIds() const override {
        return std::vector<std::string>{"kactCasp",
"kactCaspBecI",
"kactCaspp38",
"kactIntegrin",
"kactLys",
...
"ksynSox9mRNASox9A",};
    ...
    virtual std::vector<std::string> getStateIds() const override {
        return std::vector<std::string>{"AcanmRNA",
"ADAMTS5",
"AGEprod",
"Alk1",
"Alk1_Alk5",
...
"Tgfb_A",
"Tgfb_Alk1_Alk5",
"Tgfb_Alk1_Alk5_Smad7",
"Tgfb_Alk5_dimer",
"Tgfb_Alk5_dimer_Smad7",
"AggFrag",
"Aggrecan",
"Aggrecan_Collagen2",
"ColFrag",
