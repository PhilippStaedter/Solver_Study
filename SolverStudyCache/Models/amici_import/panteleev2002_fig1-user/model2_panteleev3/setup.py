...
sources = ['swig/model2_panteleev3.i', *getModelSources()]
...
# Build shared object
model_module = Extension('model2_panteleev3._model2_panteleev3',
                         sources=sources,
                         ...
                         swig_opts=['-c++', '-modern', '-outdir', 'model2_panteleev3',
...
# Install
setup(
    name='model2_panteleev3',
    version='0.1.0',
    description='AMICI-generated module for model model2_panteleev3',
