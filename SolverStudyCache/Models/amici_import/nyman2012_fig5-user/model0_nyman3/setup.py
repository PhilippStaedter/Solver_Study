...
sources = ['swig/model0_nyman3.i', *getModelSources()]
...
# Build shared object
model_module = Extension('model0_nyman3._model0_nyman3',
                         sources=sources,
                         ...
                         swig_opts=['-c++', '-modern', '-outdir', 'model0_nyman3',
...
setup(
    name='model0_nyman3',
    version='0.1.0',
    description='AMICI-generated module for model model0_nyman3',
