"""AMICI-generated module for model model6_levchenko1"""

import amici

# Ensure we are binary-compatible, see #556
if '0.10.7' != amici.__version__:
    raise RuntimeError('Cannot use model model6_levchenko1, generated with AMICI '
...
from model6_levchenko1.model6_levchenko1 import *
