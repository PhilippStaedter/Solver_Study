"""AMICI-generated module for model model4_levchenko2"""

import amici

# Ensure we are binary-compatible, see #556
if '0.10.7' != amici.__version__:
    raise RuntimeError('Cannot use model model4_levchenko2, generated with AMICI '
...
from model4_levchenko2.model4_levchenko2 import *
