...
sources = ['swig/model5_levchenko2.i', *getModelSources()]
...
# Build shared object
model_module = Extension('model5_levchenko2._model5_levchenko2',
                         sources=sources,
                         ...
                         swig_opts=['-c++', '-modern', '-outdir', 'model5_levchenko2',
...
# Install
setup(
    name='model5_levchenko2',
    version='0.1.0',
    description='AMICI-generated module for model model5_levchenko2',
