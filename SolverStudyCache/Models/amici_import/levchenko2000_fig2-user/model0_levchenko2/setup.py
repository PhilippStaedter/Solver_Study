...
sources = ['swig/model0_levchenko2.i', *getModelSources()]
...
# Build shared object
model_module = Extension('model0_levchenko2._model0_levchenko2',
                         sources=sources,
                         ...
                         swig_opts=['-c++', '-modern', '-outdir', 'model0_levchenko2',
...
# Install
setup(
    name='model0_levchenko2',
    version='0.1.0',
    description='AMICI-generated module for model model0_levchenko2',
