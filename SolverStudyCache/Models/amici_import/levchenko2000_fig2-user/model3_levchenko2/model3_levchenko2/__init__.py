"""AMICI-generated module for model model3_levchenko2"""

import amici

# Ensure we are binary-compatible, see #556
if '0.10.7' != amici.__version__:
    raise RuntimeError('Cannot use model model3_levchenko2, generated with AMICI '
...
from model3_levchenko2.model3_levchenko2 import *
