...
sources = ['swig/model1_wang1.i', *getModelSources()]
...
# Build shared object
model_module = Extension('model1_wang1._model1_wang1',
                         sources=sources,
                         ...
                         swig_opts=['-c++', '-modern', '-outdir', 'model1_wang1',
...
setup(
    name='model1_wang1',
    version='0.1.0',
    description='AMICI-generated module for model model1_wang1',
