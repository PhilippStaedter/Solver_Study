...
sources = ['swig/model0_panteleev2.i', *getModelSources()]
...
# Build shared object
model_module = Extension('model0_panteleev2._model0_panteleev2',
                         sources=sources,
                         ...
                         swig_opts=['-c++', '-modern', '-outdir', 'model0_panteleev2',
...
# Install
setup(
    name='model0_panteleev2',
    version='0.1.0',
    description='AMICI-generated module for model model0_panteleev2',
