...
void dwdp_model0_panteleev2(realtype *dwdp, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *tcl, const realtype *dtcldp, const int ip){
    switch(ip) {
        case 0:
        ...
        case 10:
            ...
            break;
        case 11:
            dwdp[6] = 1.0*VIIa_TF_Xa_TFPI;
            break;
        case 12:
            dwdp[6] = -1.0*VIIa_TF*Xa_TFPI;
            break;
        case 13:
