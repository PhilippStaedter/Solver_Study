...
sources = ['swig/model0_borghans2.i', *getModelSources()]
...
# Build shared object
model_module = Extension('model0_borghans2._model0_borghans2',
                         sources=sources,
                         ...
                         swig_opts=['-c++', '-modern', '-outdir', 'model0_borghans2',
...
# Install
setup(
    name='model0_borghans2',
    version='0.1.0',
    description='AMICI-generated module for model model0_borghans2',
