...
sources = ['swig/model0_tripathi1.i', *getModelSources()]
...
# Build shared object
model_module = Extension('model0_tripathi1._model0_tripathi1',
                         sources=sources,
                         ...
                         swig_opts=['-c++', '-modern', '-outdir', 'model0_tripathi1',
...
# Install
setup(
    name='model0_tripathi1',
    version='0.1.0',
    description='AMICI-generated module for model model0_tripathi1',
