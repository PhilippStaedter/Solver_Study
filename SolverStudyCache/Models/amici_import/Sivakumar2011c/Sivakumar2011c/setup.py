...
sources = ['swig/Sivakumar2011c.i', *getModelSources()]
...
# Build shared object
model_module = Extension('Sivakumar2011c._Sivakumar2011c',
                         sources=sources,
                         ...
                         swig_opts=['-c++', '-modern', '-outdir', 'Sivakumar2011c',
...
setup(
    name='Sivakumar2011c',
    version='0.1.0',
    description='AMICI-generated module for model Sivakumar2011c',
