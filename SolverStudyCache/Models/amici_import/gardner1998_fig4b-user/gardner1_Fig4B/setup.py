...
sources = ['swig/gardner1_Fig4B.i', *getModelSources()]
...
# Build shared object
model_module = Extension('gardner1_Fig4B._gardner1_Fig4B',
                         sources=sources,
                         ...
                         swig_opts=['-c++', '-modern', '-outdir', 'gardner1_Fig4B',
...
setup(
    name='gardner1_Fig4B',
    version='0.1.0',
    description='AMICI-generated module for model gardner1_Fig4B',
