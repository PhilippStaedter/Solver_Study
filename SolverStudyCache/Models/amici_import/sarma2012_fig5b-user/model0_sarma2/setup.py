...
sources = ['swig/model0_sarma2.i', *getModelSources()]
...
# Build shared object
model_module = Extension('model0_sarma2._model0_sarma2',
                         sources=sources,
                         ...
                         swig_opts=['-c++', '-modern', '-outdir', 'model0_sarma2',
...
setup(
    name='model0_sarma2',
    version='0.1.0',
    description='AMICI-generated module for model model0_sarma2',
