 ...
 * @return
 */
extern void J_fung1_Fig3A_Vgly_0_5(realtype *J, const realtype t, const realtype *x,
                            const realtype *p, const realtype *k,
                            const realtype *h, const realtype *w,
                            const realtype *dwdx);
extern void JB_fung1_Fig3A_Vgly_0_5(realtype *JB, const realtype t, const realtype *x,
                             const realtype *p, const realtype *k,
                             const realtype *h, const realtype *xB,
                             const realtype *w, const realtype *dwdx);
extern void JDiag_fung1_Fig3A_Vgly_0_5(realtype *JDiag, const realtype t,
                                const realtype *x, const realtype *p,
                                const realtype *k, const realtype *h,
                                const realtype *w, const realtype *dwdx);
extern void JSparse_fung1_Fig3A_Vgly_0_5(realtype *JSparse, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *dwdx);
extern void JSparse_colptrs_fung1_Fig3A_Vgly_0_5(sunindextype *colptrs);
extern void JSparse_rowvals_fung1_Fig3A_Vgly_0_5(sunindextype *rowvals);
extern void JSparseB_fung1_Fig3A_Vgly_0_5(realtype *JSparseB, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *xB, const realtype *w, const realtype *dwdx);
extern void JSparseB_colptrs_fung1_Fig3A_Vgly_0_5(sunindextype *colptrs);
extern void JSparseB_rowvals_fung1_Fig3A_Vgly_0_5(sunindextype *rowvals);
extern void Jy_fung1_Fig3A_Vgly_0_5(realtype *nllh, const int iy, const realtype *p,
                             const realtype *k, const realtype *y,
                             const realtype *sigmay, const realtype *my);
extern void dJydsigmay_fung1_Fig3A_Vgly_0_5(realtype *dJydsigmay, const int iy,
                                     const realtype *p, const realtype *k,
                                     const realtype *y, const realtype *sigmay,
                                     const realtype *my);
extern void dJydy_fung1_Fig3A_Vgly_0_5(realtype *dJydy, const int iy, const realtype *p, const realtype *k, const realtype *y, const realtype *sigmay, const realtype *my);
extern void dJydy_colptrs_fung1_Fig3A_Vgly_0_5(sunindextype *colptrs, int index);
extern void dJydy_rowvals_fung1_Fig3A_Vgly_0_5(sunindextype *rowvals, int index);
extern void dwdp_fung1_Fig3A_Vgly_0_5(realtype *dwdp, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *tcl, const realtype *dtcldp, const int ip);
extern void dwdx_fung1_Fig3A_Vgly_0_5(realtype *dwdx, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *tcl);
extern void dwdx_colptrs_fung1_Fig3A_Vgly_0_5(sunindextype *colptrs);
extern void dwdx_rowvals_fung1_Fig3A_Vgly_0_5(sunindextype *rowvals);
extern void dxdotdw_fung1_Fig3A_Vgly_0_5(realtype *dxdotdw, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w);
extern void dxdotdw_colptrs_fung1_Fig3A_Vgly_0_5(sunindextype *colptrs);
extern void dxdotdw_rowvals_fung1_Fig3A_Vgly_0_5(sunindextype *rowvals);
extern void dxdotdp_fung1_Fig3A_Vgly_0_5(realtype *dxdotdp, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const int ip, const realtype *w);
extern void dydx_fung1_Fig3A_Vgly_0_5(realtype *dydx, const realtype t,
                               const realtype *x, const realtype *p,
                               const realtype *k, const realtype *h,
                               const realtype *w, const realtype *dwdx);
extern void dydp_fung1_Fig3A_Vgly_0_5(realtype *dydp, const realtype t,
                               const realtype *x, const realtype *p,
                               const realtype *k, const realtype *h,
                               const int ip, const realtype *w,
                               const realtype *dwp);
extern void dsigmaydp_fung1_Fig3A_Vgly_0_5(realtype *dsigmaydp, const realtype t,
                                    const realtype *p, const realtype *k,
                                    const int ip);
extern void sigmay_fung1_Fig3A_Vgly_0_5(realtype *sigmay, const realtype t,
                                 const realtype *p, const realtype *k);
extern void w_fung1_Fig3A_Vgly_0_5(realtype *w, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *tcl);
extern void x0_fung1_Fig3A_Vgly_0_5(realtype *x0, const realtype t, const realtype *p,
                             const realtype *k);
extern void x0_fixedParameters_fung1_Fig3A_Vgly_0_5(realtype *x0, const realtype t,
                                             const realtype *p,
                                             const realtype *k);
extern void sx0_fung1_Fig3A_Vgly_0_5(realtype *sx0, const realtype t,
                              const realtype *x0, const realtype *p,
                              const realtype *k, const int ip);
extern void sx0_fixedParameters_fung1_Fig3A_Vgly_0_5(realtype *sx0, const realtype t,
                                              const realtype *x0,
                                              const realtype *p,
                                              const realtype *k, const int ip);
extern void xdot_fung1_Fig3A_Vgly_0_5(realtype *xdot, const realtype t,
                               const realtype *x, const realtype *p,
                               const realtype *k, const realtype *h,
                               const realtype *w);
extern void y_fung1_Fig3A_Vgly_0_5(realtype *y, const realtype t, const realtype *x,
                            const realtype *p, const realtype *k,
                            const realtype *h, const realtype *w);

extern void x_solver_fung1_Fig3A_Vgly_0_5(realtype *x_solver, const realtype *x_rdata);
extern void total_cl_fung1_Fig3A_Vgly_0_5(realtype *total_cl, const realtype *x_rdata);

/**
 * @brief AMICI-generated model subclass.
 */
class Model_fung1_Fig3A_Vgly_0_5 : public amici::Model_ODE {
  public:
    /**
     * @brief Default constructor.
     */
    Model_fung1_Fig3A_Vgly_0_5()
        : amici::Model_ODE(
              8,                                // nx_rdata
              8,                            // nxtrue_rdata
              8,                               // nx_solver
              ...
              std::vector<realtype>{100.0, 1e-07, 0.06, 0.1, 0.0005, 10.0, 10.0, 0.001, 0.5, 0.0, 0.1, 2.0, 2.0, 80.0, 0.8, 0.01, 1.0, 1.0, 10.0, 0.06, 2.0},       // dynamic parameters
    ...
    virtual amici::Model *clone() const override {
        return new Model_fung1_Fig3A_Vgly_0_5(*this);
    }
    ...
    virtual void fJ(realtype *J, const realtype t, const realtype *x,
        ...
        J_fung1_Fig3A_Vgly_0_5(J, t, x, p, k, h, w, dwdx);
    }
    ...
    virtual void fJB(realtype *JB, const realtype t, const realtype *x,
        ...
        JB_fung1_Fig3A_Vgly_0_5(JB, t, x, p, k, h, xB, w, dwdx);
    }
    ...
    virtual void fJDiag(realtype *JDiag, const realtype t, const realtype *x,
                        const realtype *p, const realtype *k, const realtype *h,
                        const realtype *w, const realtype *dwdx) override {
        JDiag_fung1_Fig3A_Vgly_0_5(JDiag, t, x, p, k, h, w, dwdx);
    }
    ...
    virtual void fJSparse(realtype *JSparse, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *dwdx) override {
        JSparse_fung1_Fig3A_Vgly_0_5( JSparse,  t,  x,  p,  k,  h,  w,  dwdx);
    }


    virtual void fJSparse_colptrs(sunindextype *colptrs) override {
        JSparse_colptrs_fung1_Fig3A_Vgly_0_5(colptrs);
    }


    virtual void fJSparse_rowvals(sunindextype *rowvals) override {
        JSparse_rowvals_fung1_Fig3A_Vgly_0_5(rowvals);
    }
    ...
    virtual void fJSparseB(realtype *JSparseB, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *xB, const realtype *w, const realtype *dwdx) override {
        JSparseB_fung1_Fig3A_Vgly_0_5( JSparseB,  t,  x,  p,  k,  h,  xB,  w,  dwdx);
    }


    virtual void fJSparseB_colptrs(sunindextype *colptrs) override {
        JSparseB_colptrs_fung1_Fig3A_Vgly_0_5(colptrs);
    }


    virtual void fJSparseB_rowvals(sunindextype *rowvals) override {
        JSparseB_rowvals_fung1_Fig3A_Vgly_0_5(rowvals);
    }
    ...
    virtual void fJy(realtype *nllh, const int iy, const realtype *p,
        ...
        Jy_fung1_Fig3A_Vgly_0_5(nllh, iy, p, k, y, sigmay, my);
    }
    ...
    virtual void fdJydsigma(realtype *dJydsigma, const int iy,
        ...
        dJydsigmay_fung1_Fig3A_Vgly_0_5(dJydsigma, iy, p, k, y, sigmay, my);
    }
    ...
    virtual void fdsigmaydp(realtype *dsigmaydp, const realtype t,
        ...
        dsigmaydp_fung1_Fig3A_Vgly_0_5(dsigmaydp, t, p, k, ip);
    }
    ...
    virtual void fdJydy(realtype *dJydy, const int iy, const realtype *p, const realtype *k, const realtype *y, const realtype *sigmay, const realtype *my) override {
        dJydy_fung1_Fig3A_Vgly_0_5( dJydy,  iy,  p,  k,  y,  sigmay,  my);
    }

    virtual void fdJydy_colptrs(sunindextype *colptrs, int index) override {
        dJydy_colptrs_fung1_Fig3A_Vgly_0_5(colptrs, index);
    }

    virtual void fdJydy_rowvals(sunindextype *rowvals, int index) override {
        dJydy_rowvals_fung1_Fig3A_Vgly_0_5(rowvals, index);
    }
    ...
    virtual void fdwdp(realtype *dwdp, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *tcl, const realtype *dtcldp, const int ip) override {
        dwdp_fung1_Fig3A_Vgly_0_5( dwdp,  t,  x,  p,  k,  h,  w,  tcl,  dtcldp,  ip);
    }
    ...
    virtual void fdwdx(realtype *dwdx, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *tcl) override {
        dwdx_fung1_Fig3A_Vgly_0_5( dwdx,  t,  x,  p,  k,  h,  w,  tcl);
    }
    ...
    virtual void fdxdotdw(realtype *dxdotdw, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w) override {
        dxdotdw_fung1_Fig3A_Vgly_0_5( dxdotdw,  t,  x,  p,  k,  h,  w);
    }


    virtual void fdxdotdw_colptrs(sunindextype *colptrs) override {
        dxdotdw_colptrs_fung1_Fig3A_Vgly_0_5(colptrs);
    }


    virtual void fdxdotdw_rowvals(sunindextype *rowvals) override {
        dxdotdw_rowvals_fung1_Fig3A_Vgly_0_5(rowvals);
    }
    ...
    virtual void fdxdotdp(realtype *dxdotdp, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const int ip, const realtype *w) override {
        dxdotdp_fung1_Fig3A_Vgly_0_5( dxdotdp,  t,  x,  p,  k,  h,  ip,  w);
    }
    ...
    virtual void fdydx(realtype *dydx, const realtype t, const realtype *x,
                       const realtype *p, const realtype *k, const realtype *h,
                       const realtype *w, const realtype *dwdx) override {
        dydx_fung1_Fig3A_Vgly_0_5(dydx, t, x, p, k, h, w, dwdx);
    }
    ...
    virtual void fdydp(realtype *dydp, const realtype t, const realtype *x,
        ...
        dydp_fung1_Fig3A_Vgly_0_5(dydp, t, x, p, k, h, ip, w, dwdp);
    }
    ...
    virtual void fsigmay(realtype *sigmay, const realtype t, const realtype *p,
        ...
        sigmay_fung1_Fig3A_Vgly_0_5(sigmay, t, p, k);
    }
    ...
    virtual void fsx0(realtype *sx0, const realtype t, const realtype *x0,
                      const realtype *p, const realtype *k,
                      const int ip) override {
        sx0_fung1_Fig3A_Vgly_0_5(sx0, t, x0, p, k, ip);
    }
    ...
    virtual void fsx0_fixedParameters(realtype *sx0, const realtype t,
                                      ...
                                      const realtype *k,
                                      const int ip) override {
        sx0_fixedParameters_fung1_Fig3A_Vgly_0_5(sx0, t, x0, p, k, ip);
    }
    ...
    virtual void fw(realtype *w, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *tcl) override {
        w_fung1_Fig3A_Vgly_0_5( w,  t,  x,  p,  k,  h,  tcl);
    }
    ...
    virtual void fx0(realtype *x0, const realtype t, const realtype *p,
                     const realtype *k) override {
        x0_fung1_Fig3A_Vgly_0_5(x0, t, p, k);
    }
    ...
    virtual void fx0_fixedParameters(realtype *x0, const realtype t,
                                     const realtype *p,
                                     const realtype *k) override {
        x0_fixedParameters_fung1_Fig3A_Vgly_0_5(x0, t, p, k);
    }
    ...
    virtual void fxdot(realtype *xdot, const realtype t, const realtype *x,
        ...
        xdot_fung1_Fig3A_Vgly_0_5(xdot, t, x, p, k, h, w);
    }
    ...
    virtual void fy(realtype *y, const realtype t, const realtype *x,
                    const realtype *p, const realtype *k, const realtype *h,
                    const realtype *w) override {
        y_fung1_Fig3A_Vgly_0_5(y, t, x, p, k, h, w);
    }
    ...
    virtual void fx_solver(realtype *x_solver, const realtype *x_rdata) override {
        x_solver_fung1_Fig3A_Vgly_0_5( x_solver,  x_rdata);
    }


    virtual void ftotal_cl(realtype *total_cl, const realtype *x_rdata) override {
        total_cl_fung1_Fig3A_Vgly_0_5( total_cl,  x_rdata);
    }
...
"",};
    ...
    virtual std::vector<std::string> getStateNames() const override {
        return std::vector<std::string>{"Acetyl-CoA",
"Acetyl phosphate",
"Acetyl-CoA synthase",
"protonated acetate",
"acetate export",
...
"n",};
    ...
    virtual std::vector<std::string> getStateIds() const override {
        return std::vector<std::string>{"AcCoA",
"AcP",
"Acs",
"HOAc",
"HOAc_E",
