...
sources = ['swig/model1_hald.i', *getModelSources()]
...
# Build shared object
model_module = Extension('model1_hald._model1_hald',
                         sources=sources,
                         ...
                         swig_opts=['-c++', '-modern', '-outdir', 'model1_hald',
...
setup(
    name='model1_hald',
    version='0.1.0',
    description='AMICI-generated module for model model1_hald',
