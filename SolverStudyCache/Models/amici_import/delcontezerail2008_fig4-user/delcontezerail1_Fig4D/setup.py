...
sources = ['swig/delcontezerail1_Fig4D.i', *getModelSources()]
...
# Build shared object
model_module = Extension('delcontezerail1_Fig4D._delcontezerail1_Fig4D',
                         sources=sources,
                         ...
                         swig_opts=['-c++', '-modern', '-outdir', 'delcontezerail1_Fig4D',
...
# Install
setup(
    name='delcontezerail1_Fig4D',
    version='0.1.0',
    description='AMICI-generated module for model delcontezerail1_Fig4D',
