 ...
 * @return
 */
extern void J_Ueda2001(realtype *J, const realtype t, const realtype *x,
                            const realtype *p, const realtype *k,
                            const realtype *h, const realtype *w,
                            const realtype *dwdx);
extern void JB_Ueda2001(realtype *JB, const realtype t, const realtype *x,
                             const realtype *p, const realtype *k,
                             const realtype *h, const realtype *xB,
                             const realtype *w, const realtype *dwdx);
extern void JDiag_Ueda2001(realtype *JDiag, const realtype t,
                                const realtype *x, const realtype *p,
                                const realtype *k, const realtype *h,
                                const realtype *w, const realtype *dwdx);
extern void JSparse_Ueda2001(realtype *JSparse, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *dwdx);
extern void JSparse_colptrs_Ueda2001(sunindextype *colptrs);
extern void JSparse_rowvals_Ueda2001(sunindextype *rowvals);
extern void JSparseB_Ueda2001(realtype *JSparseB, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *xB, const realtype *w, const realtype *dwdx);
extern void JSparseB_colptrs_Ueda2001(sunindextype *colptrs);
extern void JSparseB_rowvals_Ueda2001(sunindextype *rowvals);
extern void Jy_Ueda2001(realtype *nllh, const int iy, const realtype *p,
                             const realtype *k, const realtype *y,
                             const realtype *sigmay, const realtype *my);
extern void dJydsigmay_Ueda2001(realtype *dJydsigmay, const int iy,
                                     const realtype *p, const realtype *k,
                                     const realtype *y, const realtype *sigmay,
                                     const realtype *my);
extern void dJydy_Ueda2001(realtype *dJydy, const int iy, const realtype *p, const realtype *k, const realtype *y, const realtype *sigmay, const realtype *my);
extern void dJydy_colptrs_Ueda2001(sunindextype *colptrs, int index);
extern void dJydy_rowvals_Ueda2001(sunindextype *rowvals, int index);
extern void dwdp_Ueda2001(realtype *dwdp, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *tcl, const realtype *dtcldp, const int ip);
extern void dwdx_Ueda2001(realtype *dwdx, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *tcl);
extern void dwdx_colptrs_Ueda2001(sunindextype *colptrs);
extern void dwdx_rowvals_Ueda2001(sunindextype *rowvals);
extern void dxdotdw_Ueda2001(realtype *dxdotdw, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w);
extern void dxdotdw_colptrs_Ueda2001(sunindextype *colptrs);
extern void dxdotdw_rowvals_Ueda2001(sunindextype *rowvals);
extern void dxdotdp_Ueda2001(realtype *dxdotdp, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const int ip, const realtype *w);
extern void dydx_Ueda2001(realtype *dydx, const realtype t,
                               const realtype *x, const realtype *p,
                               const realtype *k, const realtype *h,
                               const realtype *w, const realtype *dwdx);
extern void dydp_Ueda2001(realtype *dydp, const realtype t,
                               const realtype *x, const realtype *p,
                               const realtype *k, const realtype *h,
                               const int ip, const realtype *w,
                               const realtype *dwp);
extern void dsigmaydp_Ueda2001(realtype *dsigmaydp, const realtype t,
                                    const realtype *p, const realtype *k,
                                    const int ip);
extern void sigmay_Ueda2001(realtype *sigmay, const realtype t,
                                 const realtype *p, const realtype *k);
extern void w_Ueda2001(realtype *w, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *tcl);
extern void x0_Ueda2001(realtype *x0, const realtype t, const realtype *p,
                             const realtype *k);
extern void x0_fixedParameters_Ueda2001(realtype *x0, const realtype t,
                                             const realtype *p,
                                             const realtype *k);
extern void sx0_Ueda2001(realtype *sx0, const realtype t,
                              const realtype *x0, const realtype *p,
                              const realtype *k, const int ip);
extern void sx0_fixedParameters_Ueda2001(realtype *sx0, const realtype t,
                                              const realtype *x0,
                                              const realtype *p,
                                              const realtype *k, const int ip);
extern void xdot_Ueda2001(realtype *xdot, const realtype t,
                               const realtype *x, const realtype *p,
                               const realtype *k, const realtype *h,
                               const realtype *w);
extern void y_Ueda2001(realtype *y, const realtype t, const realtype *x,
                            const realtype *p, const realtype *k,
                            const realtype *h, const realtype *w);

extern void x_solver_Ueda2001(realtype *x_solver, const realtype *x_rdata);
extern void total_cl_Ueda2001(realtype *total_cl, const realtype *x_rdata);

/**
 * @brief AMICI-generated model subclass.
 */
class Model_Ueda2001 : public amici::Model_ODE {
  public:
    /**
    ...
    Model_Ueda2001()
        : amici::Model_ODE(
              ...
              std::vector<realtype>{4.0, 1.45, 1.02, 0.0, 0.0, 0.45, 1.0, 0.012, 4.0, 1.45, 1.02, 0.0, 0.0, 0.45, 1.0, 0.012, 4.0, 1.63, 0.89, 0.0, 0.6, 0.8, 1.0, 0.012, 1.63, 2.0, 0.52, 2.0, 0.72, 2.0, 1.73, 2.0, 1.63, 1.63, 1.45, 1.45, 0.48, 0.47, 0.48, 0.012, 0.012, 0.012, 0.012, 0.012, 0.012, 0.012, 0.3, 0.94, 0.2, 0.44, 0.3, 0.94, 0.2, 0.44, 0.2, 0.44, 0.2, 0.29, 0.13, 0.54, 0.2, 0.6, 0.2, 0.6, 0.2, 0.3},       // dynamic parameters
    ...
    virtual amici::Model *clone() const override {
        return new Model_Ueda2001(*this);
    }
    ...
    virtual void fJB(realtype *JB, const realtype t, const realtype *x,
        ...
        JB_Ueda2001(JB, t, x, p, k, h, xB, w, dwdx);
    }
    ...
    virtual void fJDiag(realtype *JDiag, const realtype t, const realtype *x,
                        const realtype *p, const realtype *k, const realtype *h,
                        const realtype *w, const realtype *dwdx) override {
        JDiag_Ueda2001(JDiag, t, x, p, k, h, w, dwdx);
    }
    ...
    virtual void fJy(realtype *nllh, const int iy, const realtype *p,
        ...
        Jy_Ueda2001(nllh, iy, p, k, y, sigmay, my);
    }
    ...
    virtual void fdJydsigma(realtype *dJydsigma, const int iy,
        ...
        dJydsigmay_Ueda2001(dJydsigma, iy, p, k, y, sigmay, my);
    }
    ...
    virtual void fdsigmaydp(realtype *dsigmaydp, const realtype t,
        ...
        dsigmaydp_Ueda2001(dsigmaydp, t, p, k, ip);
    }
    ...
    virtual void fdwdp(realtype *dwdp, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *tcl, const realtype *dtcldp, const int ip) override {
        dwdp_Ueda2001( dwdp,  t,  x,  p,  k,  h,  w,  tcl,  dtcldp,  ip);
    }
    ...
    virtual void fdwdx(realtype *dwdx, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *tcl) override {
        dwdx_Ueda2001( dwdx,  t,  x,  p,  k,  h,  w,  tcl);
    }
    ...
    virtual void fdxdotdp(realtype *dxdotdp, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const int ip, const realtype *w) override {
        dxdotdp_Ueda2001( dxdotdp,  t,  x,  p,  k,  h,  ip,  w);
    }
    ...
    virtual void fdydx(realtype *dydx, const realtype t, const realtype *x,
                       const realtype *p, const realtype *k, const realtype *h,
                       const realtype *w, const realtype *dwdx) override {
        dydx_Ueda2001(dydx, t, x, p, k, h, w, dwdx);
    }
    ...
    virtual void fdydp(realtype *dydp, const realtype t, const realtype *x,
        ...
        dydp_Ueda2001(dydp, t, x, p, k, h, ip, w, dwdp);
    }
    ...
    virtual void fsx0_fixedParameters(realtype *sx0, const realtype t,
                                      ...
                                      const realtype *k,
                                      const int ip) override {
        sx0_fixedParameters_Ueda2001(sx0, t, x0, p, k, ip);
    }
    ...
    virtual void fx0_fixedParameters(realtype *x0, const realtype t,
                                     const realtype *p,
                                     const realtype *k) override {
        x0_fixedParameters_Ueda2001(x0, t, p, k);
    }
    ...
    virtual void fxdot(realtype *xdot, const realtype t, const realtype *x,
        ...
        xdot_Ueda2001(xdot, t, x, p, k, h, w);
    }
...
"x12",};
    ...
    virtual std::vector<std::string> getParameterIds() const override {
        return std::vector<std::string>{"Reaction1_r",
"Reaction1_s1",
"Reaction1_r1",
"Reaction1_c1",
"Reaction1_B1",
...
"Reaction10_T1",
"Reaction10_k1",
"Reaction11_parameter_0000073",
"Reaction11_v3",
"Reaction12_parameter_0000072",
"Reaction12_v1",
"Reaction16_s4",
"Reaction18_s6",
"Reaction19_s2",
...
"Reaction37_D10",};
    ...
    virtual std::vector<std::string> getStateIds() const override {
        return std::vector<std::string>{"EmptySet",
"CCc",
"CCn",
"Clkc",
"Clkm",
